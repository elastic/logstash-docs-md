...
| [`pipeline`](v7-4-2-plugins-outputs-elasticsearch.md#v7.4.2-plugins-outputs-elasticsearch-pipeline) | [string](logstash://reference/configuration-file-structure.md#string) | No |
