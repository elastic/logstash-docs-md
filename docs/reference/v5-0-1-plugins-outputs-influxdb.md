...
| [`max_retries`](v5-0-1-plugins-outputs-influxdb.md#v5.0.1-plugins-outputs-influxdb-max_retries) | [number](logstash://reference/configuration-file-structure.md#number) | No |
