...
| [`metadata_target`](v5-0-1-plugins-inputs-http_poller.md#v5.0.1-plugins-inputs-http_poller-metadata_target) | [string](logstash://reference/configuration-file-structure.md#string) | No |
