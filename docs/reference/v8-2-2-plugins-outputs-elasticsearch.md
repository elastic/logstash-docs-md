...
| [`pipeline`](v8-2-2-plugins-outputs-elasticsearch.md#v8.2.2-plugins-outputs-elasticsearch-pipeline) | [string](logstash://reference/configuration-file-structure.md#string) | No |
