...
| [`syslog_field`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-syslog_field) | [string](logstash://reference/configuration-file-structure.md#string) | No |
