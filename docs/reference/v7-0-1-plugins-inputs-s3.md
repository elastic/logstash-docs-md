...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)][Elastic Common Schema (ECS)](ecs://docs/reference/index.md)). See [Event Metadata and the Elastic Common Schema (ECS)](v7-0-1-plugins-inputs-s3.md#v7.0.1-plugins-inputs-s3-ecs_metadata) for detailed information.
