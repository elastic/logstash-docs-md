...
| [`max_poll_records`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-max_poll_records) | [string](logstash://reference/configuration-file-structure.md#string) | No |
