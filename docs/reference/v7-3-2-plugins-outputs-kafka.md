...
| [`ssl_truststore_password`](v7-3-2-plugins-outputs-kafka.md#v7.3.2-plugins-outputs-kafka-ssl_truststore_password) | [password](logstash://reference/configuration-file-structure.md#password) | No |
