...
| [`retry_backoff_ms`](v7-0-1-plugins-outputs-kafka.md#v7.0.1-plugins-outputs-kafka-retry_backoff_ms) | [number](logstash://reference/configuration-file-structure.md#number) | No |
