...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)][Elastic Common Schema (ECS)](ecs://docs/reference/index.md)). The value of this setting affects the behavior of the [`clones`](v4-1-0-plugins-filters-clone.md#v4.1.0-plugins-filters-clone-clones)
