...
| [`ssl_handshake_timeout`](v6-0-3-plugins-inputs-beats.md#v6.0.3-plugins-inputs-beats-ssl_handshake_timeout) | [number](logstash://reference/configuration-file-structure.md#number) | No |
