...
| [`pool_max`](v5-0-2-plugins-inputs-http_poller.md#v5.0.2-plugins-inputs-http_poller-pool_max) | [number](logstash://reference/configuration-file-structure.md#number) | No |
