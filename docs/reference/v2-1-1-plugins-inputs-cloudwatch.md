...
| [`role_arn`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-role_arn) | [string](logstash://reference/configuration-file-structure.md#string) | No |
