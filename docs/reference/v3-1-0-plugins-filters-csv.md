...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)][Elastic Common Schema (ECS)](ecs://docs/reference/index.md)). See [Event Metadata and the Elastic Common Schema (ECS)](v3-1-0-plugins-filters-csv.md#v3.1.0-plugins-filters-csv-ecs_metadata) for detailed information.
