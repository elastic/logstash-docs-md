...
| [`fetch_max_wait_ms`](v8-0-0-plugins-inputs-kafka.md#v8.0.0-plugins-inputs-kafka-fetch_max_wait_ms) | [string](logstash://reference/configuration-file-structure.md#string) | No |
