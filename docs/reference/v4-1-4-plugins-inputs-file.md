...
| [`max_open_files`](v4-1-4-plugins-inputs-file.md#v4.1.4-plugins-inputs-file-max_open_files) | [number](logstash://reference/configuration-file-structure.md#number) | No |
