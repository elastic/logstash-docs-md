...
| [`session_token`](v4-1-6-plugins-outputs-s3.md#v4.1.6-plugins-outputs-s3-session_token) | [string](logstash://reference/configuration-file-structure.md#string) | No |
