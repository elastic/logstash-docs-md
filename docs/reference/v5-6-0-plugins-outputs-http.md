...
| [`request_timeout`](v5-6-0-plugins-outputs-http.md#v5.6.0-plugins-outputs-http-request_timeout) | [number](logstash://reference/configuration-file-structure.md#number) | No |
