...
| [`retry_backoff_ms`](v6-2-0-plugins-outputs-kafka.md#v6.2.0-plugins-outputs-kafka-retry_backoff_ms) | [number](logstash://reference/configuration-file-structure.md#number) | No |
