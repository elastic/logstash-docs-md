...
| [`metadata_target`](v3-3-4-plugins-inputs-http_poller.md#v3.3.4-plugins-inputs-http_poller-metadata_target) | [string](logstash://reference/configuration-file-structure.md#string) | No |
