...
| [`max_poll_interval_ms`](v8-1-0-plugins-inputs-kafka.md#v8.1.0-plugins-inputs-kafka-max_poll_interval_ms) | [string](logstash://reference/configuration-file-structure.md#string) | No |
