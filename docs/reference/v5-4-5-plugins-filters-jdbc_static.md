...
| --- | --- | --- |
| [`jdbc_connection_string`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-jdbc_connection_string) | [string](logstash://reference/configuration-file-structure.md#string) | Yes |
| [`jdbc_driver_class`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-jdbc_driver_class) | [string](logstash://reference/configuration-file-structure.md#string) | Yes |
...
| [`jdbc_password`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-jdbc_password) | [password](logstash://reference/configuration-file-structure.md#password) | No |
| [`jdbc_user`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-jdbc_user) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`tag_on_failure`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-tag_on_failure) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`tag_on_default_use`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-tag_on_default_use) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`staging_directory`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-staging_directory) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`loader_schedule`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-loader_schedule) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`loaders`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-loaders) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`local_db_objects`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-local_db_objects) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`local_lookups`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-local_lookups) | [array](logstash://reference/configuration-file-structure.md#array) | No |
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`add_tag`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-add_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`enable_metric`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`periodic_flush`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-periodic_flush) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`remove_field`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-remove_field) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`remove_tag`](v5-4-5-plugins-filters-jdbc_static.md#v5.4.5-plugins-filters-jdbc_static-remove_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
