...
| [`retry_backoff_ms`](v6-2-1-plugins-outputs-kafka.md#v6.2.1-plugins-outputs-kafka-retry_backoff_ms) | [number](logstash://reference/configuration-file-structure.md#number) | No |
