...
| [`metadata_target`](v4-0-0-plugins-inputs-http_poller.md#v4.0.0-plugins-inputs-http_poller-metadata_target) | [string](logstash://reference/configuration-file-structure.md#string) | No |
