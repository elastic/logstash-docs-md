...
| --- | --- | --- |
| [`locale`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-locale) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`match`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-match) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`tag_on_failure`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-tag_on_failure) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`target`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-target) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`timezone`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-timezone) | [string](logstash://reference/configuration-file-structure.md#string) | No |
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`add_tag`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-add_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`enable_metric`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`periodic_flush`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-periodic_flush) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`remove_field`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-remove_field) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`remove_tag`](v3-1-11-plugins-filters-date.md#v3.1.11-plugins-filters-date-remove_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
