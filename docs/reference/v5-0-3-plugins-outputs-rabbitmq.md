...
| [`message_properties`](v5-0-3-plugins-outputs-rabbitmq.md#v5.0.3-plugins-outputs-rabbitmq-message_properties) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
