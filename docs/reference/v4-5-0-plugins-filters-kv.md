...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)][Elastic Common Schema (ECS)\]\(([^:]+)://reference/index.md)). See [Event Metadata and the Elastic Common Schema (ECS)](v4-5-0-plugins-filters-kv.md#v4.5.0-plugins-filters-kv-ecs_metadata) for detailed information.
