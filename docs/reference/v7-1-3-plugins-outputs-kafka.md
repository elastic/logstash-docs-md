...
| [`ssl_truststore_type`](v7-1-3-plugins-outputs-kafka.md#v7.1.3-plugins-outputs-kafka-ssl_truststore_type) | [string](logstash://reference/configuration-file-structure.md#string) | No |
