...
**Logstash Core Plugin.** The java\_plain codec plugin cannot be installed or uninstalled independently of Logstash.
...
Set the desired text format for encoding in [`sprintf`](https://www.elastic.co/guide/en/logstash/current/event-dependent-configuration.html#sprintf) format.
