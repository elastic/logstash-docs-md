...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-file-index.html).
...
Duration settings can be specified in text form e.g. "250 ms", this string will be converted into decimal seconds. There are quite a few supported natural and abbreviated durations, see [string\_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) for the details.
...
| [`close_older`](plugins-inputs-file.md#plugins-inputs-file-close_older) | [number](value-types.md#number) or [string\_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
...
| [`ignore_older`](plugins-inputs-file.md#plugins-inputs-file-ignore_older) | [number](value-types.md#number) or [string\_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
...
| [`sincedb_clean_after`](plugins-inputs-file.md#plugins-inputs-file-sincedb_clean_after) | [number](value-types.md#number) or [string\_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
| [`sincedb_path`](plugins-inputs-file.md#plugins-inputs-file-sincedb_path) | [string](value-types.md#string) | No |
| [`sincedb_write_interval`](plugins-inputs-file.md#plugins-inputs-file-sincedb_write_interval) | [number](value-types.md#number) or [string\_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
...
| [`stat_interval`](plugins-inputs-file.md#plugins-inputs-file-stat_interval) | [number](value-types.md#number) or [string\_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
...
* Value type is [number](value-types.md#number) or [string\_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration)
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/8.17/index.html).
...
You may also configure multiple paths. See an example on the [Logstash configuration page](value-types.md#array).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-file.md#plugins-inputs-file-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-file.md#plugins-inputs-file-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-file.md#plugins-inputs-file-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-file.md#plugins-inputs-file-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-file.md#plugins-inputs-file-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-file.md#plugins-inputs-file-type) | [string](value-types.md#string) | No |
