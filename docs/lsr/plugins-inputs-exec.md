...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-exec-index.html).
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/8.17). See [Compatibility with the Elastic Common Schema (ECS)](plugins-inputs-exec.md#plugins-inputs-exec-ecs) for detailed information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-exec.md#plugins-inputs-exec-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-exec.md#plugins-inputs-exec-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-exec.md#plugins-inputs-exec-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-exec.md#plugins-inputs-exec-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-exec.md#plugins-inputs-exec-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-exec.md#plugins-inputs-exec-type) | [string](value-types.md#string) | No |
