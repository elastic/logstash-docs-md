...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-cidr-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-cidr.md#plugins-filters-cidr-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-cidr.md#plugins-filters-cidr-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-cidr.md#plugins-filters-cidr-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-cidr.md#plugins-filters-cidr-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-cidr.md#plugins-filters-cidr-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-cidr.md#plugins-filters-cidr-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-cidr.md#plugins-filters-cidr-remove_tag) | [array](value-types.md#array) | No |
