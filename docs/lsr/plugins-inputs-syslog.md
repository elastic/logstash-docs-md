...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-syslog-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-syslog.md#plugins-inputs-syslog-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-syslog.md#plugins-inputs-syslog-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-syslog.md#plugins-inputs-syslog-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-syslog.md#plugins-inputs-syslog-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-syslog.md#plugins-inputs-syslog-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-syslog.md#plugins-inputs-syslog-type) | [string](value-types.md#string) | No |
