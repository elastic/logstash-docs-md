...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-unix-index.html).
...
This plugin adds extra fields about the event’s source. Configure the [`ecs_compatibility`](plugins-inputs-unix.md#plugins-inputs-unix-ecs_compatibility) option if you want to ensure that these fields are compatible with [ECS](https://www.elastic.co/guide/en/ecs/8.17).
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/8.17). See [Compatibility with the Elastic Common Schema (ECS)](plugins-inputs-unix.md#plugins-inputs-unix-ecs) for detailed information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-unix.md#plugins-inputs-unix-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-unix.md#plugins-inputs-unix-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-unix.md#plugins-inputs-unix-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-unix.md#plugins-inputs-unix-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-unix.md#plugins-inputs-unix-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-unix.md#plugins-inputs-unix-type) | [string](value-types.md#string) | No |
