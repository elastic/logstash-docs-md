...
For other versions, see the [Versioned plugin docs](/vpr/filter-bytes-index.md).

## Installation [_installation_56]

For plugins not bundled by default, it is easy to install by running `bin/logstash-plugin install logstash-filter-bytes`. See [Working with plugins](logstash://reference/working-with-plugins.md) for more details.
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](plugins-filters-bytes.md#plugins-filters-bytes-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`add_tag`](plugins-filters-bytes.md#plugins-filters-bytes-add_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`enable_metric`](plugins-filters-bytes.md#plugins-filters-bytes-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](plugins-filters-bytes.md#plugins-filters-bytes-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`periodic_flush`](plugins-filters-bytes.md#plugins-filters-bytes-periodic_flush) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`remove_field`](plugins-filters-bytes.md#plugins-filters-bytes-remove_field) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`remove_tag`](plugins-filters-bytes.md#plugins-filters-bytes-remove_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
