...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-azure_event_hubs-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-azure_event_hubs.md#plugins-inputs-azure_event_hubs-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-azure_event_hubs.md#plugins-inputs-azure_event_hubs-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-azure_event_hubs.md#plugins-inputs-azure_event_hubs-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-azure_event_hubs.md#plugins-inputs-azure_event_hubs-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-azure_event_hubs.md#plugins-inputs-azure_event_hubs-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-azure_event_hubs.md#plugins-inputs-azure_event_hubs-type) | [string](value-types.md#string) | No |
