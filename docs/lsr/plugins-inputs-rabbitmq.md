...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-rabbitmq-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-type) | [string](value-types.md#string) | No |
