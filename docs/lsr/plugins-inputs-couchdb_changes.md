...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-couchdb_changes-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-couchdb_changes.md#plugins-inputs-couchdb_changes-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-couchdb_changes.md#plugins-inputs-couchdb_changes-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-couchdb_changes.md#plugins-inputs-couchdb_changes-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-couchdb_changes.md#plugins-inputs-couchdb_changes-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-couchdb_changes.md#plugins-inputs-couchdb_changes-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-couchdb_changes.md#plugins-inputs-couchdb_changes-type) | [string](value-types.md#string) | No |
