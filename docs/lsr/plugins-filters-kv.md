...
| [`remove_tag`](plugins-filters-kv.md#plugins-filters-kv-remove_tag) | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
