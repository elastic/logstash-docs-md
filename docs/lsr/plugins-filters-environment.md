...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-environment-index.html).

## Installation [_installation_59]

For plugins not bundled by default, it is easy to install by running `bin/logstash-plugin install logstash-filter-environment`. See [Working with plugins](https://www.elastic.co/guide/en/logstash/8.18/working-with-plugins.html) for more details.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-environment.md#plugins-filters-environment-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-environment.md#plugins-filters-environment-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-environment.md#plugins-filters-environment-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-environment.md#plugins-filters-environment-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-environment.md#plugins-filters-environment-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-environment.md#plugins-filters-environment-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-environment.md#plugins-filters-environment-remove_tag) | [array](value-types.md#array) | No |
