...
For other versions, see the [Versioned plugin docs](/vpr/output-csv-index.md).
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`codec`](plugins-outputs-csv.md#plugins-outputs-csv-codec) | [codec](logstash://reference/configuration-file-structure.md#codec) | No |
| [`enable_metric`](plugins-outputs-csv.md#plugins-outputs-csv-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](plugins-outputs-csv.md#plugins-outputs-csv-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
