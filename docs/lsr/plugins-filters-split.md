...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-split-index.html).
...
An example use case of this filter is for taking output from the [exec input plugin](https://www.elastic.co/guide/en/logstash/8.18/plugins-inputs-exec.html) which emits one event for the whole output of a command and splitting that output by newline - making each line an event.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-split.md#plugins-filters-split-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-split.md#plugins-filters-split-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-split.md#plugins-filters-split-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-split.md#plugins-filters-split-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-split.md#plugins-filters-split-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-split.md#plugins-filters-split-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-split.md#plugins-filters-split-remove_tag) | [array](value-types.md#array) | No |
