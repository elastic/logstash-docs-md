...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-heartbeat-index.html).
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/8.17). Refer to [Elastic Common Schema (ECS)](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-ecs) in this topic for detailed information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-type) | [string](value-types.md#string) | No |
