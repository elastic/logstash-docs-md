...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-ruby-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-ruby.md#plugins-filters-ruby-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-ruby.md#plugins-filters-ruby-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-ruby.md#plugins-filters-ruby-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-ruby.md#plugins-filters-ruby-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-ruby.md#plugins-filters-ruby-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-ruby.md#plugins-filters-ruby-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-ruby.md#plugins-filters-ruby-remove_tag) | [array](value-types.md#array) | No |
