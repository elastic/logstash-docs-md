...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/output-statsd-index.html).

## Installation [_installation_47]

For plugins not bundled by default, it is easy to install by running `bin/logstash-plugin install logstash-output-statsd`. See [Working with plugins](https://www.elastic.co/guide/en/logstash/8.18/working-with-plugins.html) for more details.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-statsd.md#plugins-outputs-statsd-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-statsd.md#plugins-outputs-statsd-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-outputs-statsd.md#plugins-outputs-statsd-id) | [string](value-types.md#string) | No |
