...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-urldecode-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-urldecode.md#plugins-filters-urldecode-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-urldecode.md#plugins-filters-urldecode-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-urldecode.md#plugins-filters-urldecode-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-urldecode.md#plugins-filters-urldecode-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-urldecode.md#plugins-filters-urldecode-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-urldecode.md#plugins-filters-urldecode-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-urldecode.md#plugins-filters-urldecode-remove_tag) | [array](value-types.md#array) | No |
