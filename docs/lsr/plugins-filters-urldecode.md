...
For other versions, see the [Versioned plugin docs](/vpr/filter-urldecode-index.md).
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](plugins-filters-urldecode.md#plugins-filters-urldecode-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`add_tag`](plugins-filters-urldecode.md#plugins-filters-urldecode-add_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`enable_metric`](plugins-filters-urldecode.md#plugins-filters-urldecode-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](plugins-filters-urldecode.md#plugins-filters-urldecode-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`periodic_flush`](plugins-filters-urldecode.md#plugins-filters-urldecode-periodic_flush) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`remove_field`](plugins-filters-urldecode.md#plugins-filters-urldecode-remove_field) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`remove_tag`](plugins-filters-urldecode.md#plugins-filters-urldecode-remove_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
