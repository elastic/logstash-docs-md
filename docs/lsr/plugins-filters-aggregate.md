...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-aggregate-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-aggregate.md#plugins-filters-aggregate-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-aggregate.md#plugins-filters-aggregate-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-aggregate.md#plugins-filters-aggregate-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-aggregate.md#plugins-filters-aggregate-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-aggregate.md#plugins-filters-aggregate-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-aggregate.md#plugins-filters-aggregate-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-aggregate.md#plugins-filters-aggregate-remove_tag) | [array](value-types.md#array) | No |
