...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-snmptrap-index.html).
...
Before you upgrade to Logstash 8.15.0, be aware of [behavioral and mapping differences](https://www.elastic.co/guide/en/logstash/8.18/plugins-integrations-snmp.html#plugins-integrations-snmp-migration) between current stand-alone plugins and the new versions included in `integration-snmp`. If you need to maintain current mappings for the `input-snmptrap` plugin, you have options to [preserve existing behavior](https://www.elastic.co/guide/en/logstash/8.18/plugins-integrations-snmp.html#plugins-integrations-snmp-input-snmptrap-compat).
...
This plugin already includes the IETF MIBs (management information bases), and you do not need to import them. If you need additional MIBs, you need to import them. Check out [Importing MIBs](https://www.elastic.co/guide/en/logstash/8.18/plugins-integrations-snmp.html#plugins-integrations-snmp-import-mibs) for info.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-type) | [string](value-types.md#string) | No |
