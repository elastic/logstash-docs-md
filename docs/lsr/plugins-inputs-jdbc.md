...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-jdbc-index.html).
...
| [`target`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-target) | [field reference](https://www.elastic.co/guide/en/logstash/8.18/field-references-deepdive.html) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-type) | [string](value-types.md#string) | No |
