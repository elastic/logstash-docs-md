...
For other versions, see the [Versioned plugin docs](/vpr/output-http-index.md).
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`codec`](plugins-outputs-http.md#plugins-outputs-http-codec) | [codec](logstash://reference/configuration-file-structure.md#codec) | No |
| [`enable_metric`](plugins-outputs-http.md#plugins-outputs-http-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](plugins-outputs-http.md#plugins-outputs-http-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
