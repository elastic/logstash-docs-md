...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-sleep-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-sleep.md#plugins-filters-sleep-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-sleep.md#plugins-filters-sleep-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-sleep.md#plugins-filters-sleep-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-sleep.md#plugins-filters-sleep-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-sleep.md#plugins-filters-sleep-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-sleep.md#plugins-filters-sleep-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-sleep.md#plugins-filters-sleep-remove_tag) | [array](value-types.md#array) | No |
