...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-translate-index.html).
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/8.17). The value of this setting affects the *default* value of [`target`](plugins-filters-translate.md#plugins-filters-translate-target).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-translate.md#plugins-filters-translate-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-translate.md#plugins-filters-translate-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-translate.md#plugins-filters-translate-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-translate.md#plugins-filters-translate-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-translate.md#plugins-filters-translate-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-translate.md#plugins-filters-translate-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-translate.md#plugins-filters-translate-remove_tag) | [array](value-types.md#array) | No |
