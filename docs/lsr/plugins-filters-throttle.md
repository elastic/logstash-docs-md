...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-throttle-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-throttle.md#plugins-filters-throttle-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-throttle.md#plugins-filters-throttle-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-throttle.md#plugins-filters-throttle-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-throttle.md#plugins-filters-throttle-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-throttle.md#plugins-filters-throttle-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-throttle.md#plugins-filters-throttle-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-throttle.md#plugins-filters-throttle-remove_tag) | [array](value-types.md#array) | No |
