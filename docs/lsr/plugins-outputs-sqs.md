...
For other versions, see the [Versioned plugin docs](/vpr/output-sqs-index.md).
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`codec`](plugins-outputs-sqs.md#plugins-outputs-sqs-codec) | [codec](logstash://reference/configuration-file-structure.md#codec) | No |
| [`enable_metric`](plugins-outputs-sqs.md#plugins-outputs-sqs-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](plugins-outputs-sqs.md#plugins-outputs-sqs-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
