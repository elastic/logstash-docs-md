...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-elastic_integration-index.html).
...
Elastic Integrations are designed to work with [data streams](https://www.elastic.co/guide/en/logstash/8.18/plugins-outputs-elasticsearch.html#plugins-outputs-elasticsearch-data-streams) and [ECS-compatible](https://www.elastic.co/guide/en/logstash/8.18/plugins-outputs-elasticsearch.html#_compatibility_with_the_elastic_common_schema_ecs) output. Be sure that these features are enabled in the [`output-elasticsearch`](https://www.elastic.co/guide/en/logstash/8.18/plugins-outputs-elasticsearch.html) plugin.

* Set [`data-stream`](https://www.elastic.co/guide/en/logstash/8.18/plugins-outputs-elasticsearch.html#plugins-outputs-elasticsearch-data_stream) to `true`.\
  (Check out [Data streams](https://www.elastic.co/guide/en/logstash/8.18/plugins-outputs-elasticsearch.html#plugins-outputs-elasticsearch-data-streams) for additional data streams settings.)
* Set [`ecs-compatibility`](https://www.elastic.co/guide/en/logstash/8.18/plugins-outputs-elasticsearch.html#plugins-outputs-elasticsearch-ecs_compatibility) to `v1` or `v8`.

Check out the [`output-elasticsearch` plugin](https://www.elastic.co/guide/en/logstash/8.18/plugins-outputs-elasticsearch.html) docs for additional settings.
...
* Value may be a [sprintf-style](https://www.elastic.co/guide/en/logstash/8.18/event-dependent-configuration.html#sprintf) template; if any referenced fields cannot be resolved the event will not be routed to an ingest pipeline.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-elastic_integration.md#plugins-filters-elastic_integration-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-elastic_integration.md#plugins-filters-elastic_integration-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-elastic_integration.md#plugins-filters-elastic_integration-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-elastic_integration.md#plugins-filters-elastic_integration-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-elastic_integration.md#plugins-filters-elastic_integration-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-elastic_integration.md#plugins-filters-elastic_integration-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-elastic_integration.md#plugins-filters-elastic_integration-remove_tag) | [array](value-types.md#array) | No |
