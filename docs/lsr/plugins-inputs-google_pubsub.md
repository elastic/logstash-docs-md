...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-google_pubsub-index.html).

## Installation [_installation_3]

For plugins not bundled by default, it is easy to install by running `bin/logstash-plugin install logstash-input-google_pubsub`. See [Working with plugins](https://www.elastic.co/guide/en/logstash/8.18/working-with-plugins.html) for more details.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-google_pubsub.md#plugins-inputs-google_pubsub-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-google_pubsub.md#plugins-inputs-google_pubsub-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-google_pubsub.md#plugins-inputs-google_pubsub-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-google_pubsub.md#plugins-inputs-google_pubsub-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-google_pubsub.md#plugins-inputs-google_pubsub-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-google_pubsub.md#plugins-inputs-google_pubsub-type) | [string](value-types.md#string) | No |
