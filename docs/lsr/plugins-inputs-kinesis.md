...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-kinesis-index.html).

## Installation [_installation_6]

For plugins not bundled by default, it is easy to install by running `bin/logstash-plugin install logstash-input-kinesis`. See [Working with plugins](https://www.elastic.co/guide/en/logstash/8.18/working-with-plugins.html) for more details.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-kinesis.md#plugins-inputs-kinesis-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-kinesis.md#plugins-inputs-kinesis-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-kinesis.md#plugins-inputs-kinesis-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-kinesis.md#plugins-inputs-kinesis-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-kinesis.md#plugins-inputs-kinesis-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-kinesis.md#plugins-inputs-kinesis-type) | [string](value-types.md#string) | No |
