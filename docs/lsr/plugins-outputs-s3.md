...
For other versions, see the [Versioned plugin docs](/vpr/output-s3-index.md).
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`codec`](plugins-outputs-s3.md#plugins-outputs-s3-codec) | [codec](logstash://reference/configuration-file-structure.md#codec) | No |
| [`enable_metric`](plugins-outputs-s3.md#plugins-outputs-s3-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](plugins-outputs-s3.md#plugins-outputs-s3-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
