...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-mutate-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-mutate.md#plugins-filters-mutate-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-mutate.md#plugins-filters-mutate-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-mutate.md#plugins-filters-mutate-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-mutate.md#plugins-filters-mutate-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-mutate.md#plugins-filters-mutate-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-mutate.md#plugins-filters-mutate-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-mutate.md#plugins-filters-mutate-remove_tag) | [array](value-types.md#array) | No |
