...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-truncate-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-truncate.md#plugins-filters-truncate-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-truncate.md#plugins-filters-truncate-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-truncate.md#plugins-filters-truncate-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-truncate.md#plugins-filters-truncate-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-truncate.md#plugins-filters-truncate-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-truncate.md#plugins-filters-truncate-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-truncate.md#plugins-filters-truncate-remove_tag) | [array](value-types.md#array) | No |
