...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/output-sns-index.html).
...
This plugin used to have a `format` option for controlling the encoding of messages prior to being sent to SNS. This plugin now uses the logstash standard [codec](value-types.md#codec) option for encoding instead. If you want the same *plain* format as the v0/1 codec (`format => "plain"`) use `codec => "s3_plain"`.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-sns.md#plugins-outputs-sns-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-sns.md#plugins-outputs-sns-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-outputs-sns.md#plugins-outputs-sns-id) | [string](value-types.md#string) | No |
