...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-age-index.html).

## Installation [_installation_54]

For plugins not bundled by default, it is easy to install by running `bin/logstash-plugin install logstash-filter-age`. See [Working with plugins](https://www.elastic.co/guide/en/logstash/8.18/working-with-plugins.html) for more details.
...
This filter calculates the age of an event by subtracting the event timestamp from the current timestamp. You can use this plugin with the [`drop` filter plugin](https://www.elastic.co/guide/en/logstash/8.18/plugins-filters-drop.html) to drop Logstash events that are older than some threshold.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-age.md#plugins-filters-age-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-age.md#plugins-filters-age-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-age.md#plugins-filters-age-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-age.md#plugins-filters-age-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-age.md#plugins-filters-age-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-age.md#plugins-filters-age-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-age.md#plugins-filters-age-remove_tag) | [array](value-types.md#array) | No |
