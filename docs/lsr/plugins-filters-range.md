...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-range-index.html).

## Installation [_installation_64]

For plugins not bundled by default, it is easy to install by running `bin/logstash-plugin install logstash-filter-range`. See [Working with plugins](https://www.elastic.co/guide/en/logstash/8.18/working-with-plugins.html) for more details.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-range.md#plugins-filters-range-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-range.md#plugins-filters-range-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-range.md#plugins-filters-range-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-range.md#plugins-filters-range-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-range.md#plugins-filters-range-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-range.md#plugins-filters-range-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-range.md#plugins-filters-range-remove_tag) | [array](value-types.md#array) | No |
