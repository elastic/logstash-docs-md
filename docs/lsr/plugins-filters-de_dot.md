...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-de_dot-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-de_dot.md#plugins-filters-de_dot-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-de_dot.md#plugins-filters-de_dot-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-de_dot.md#plugins-filters-de_dot-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-de_dot.md#plugins-filters-de_dot-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-de_dot.md#plugins-filters-de_dot-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-de_dot.md#plugins-filters-de_dot-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-de_dot.md#plugins-filters-de_dot-remove_tag) | [array](value-types.md#array) | No |
