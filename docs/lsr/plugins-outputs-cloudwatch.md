...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/output-cloudwatch-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-cloudwatch.md#plugins-outputs-cloudwatch-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-cloudwatch.md#plugins-outputs-cloudwatch-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-outputs-cloudwatch.md#plugins-outputs-cloudwatch-id) | [string](value-types.md#string) | No |
