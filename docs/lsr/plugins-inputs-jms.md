...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-jms-index.html).
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/8.17). The value of this setting affects the *default* value of [`headers_target`](plugins-inputs-jms.md#plugins-inputs-jms-headers_target) and [`properties_target`](plugins-inputs-jms.md#plugins-inputs-jms-properties_target).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-jms.md#plugins-inputs-jms-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-jms.md#plugins-inputs-jms-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-jms.md#plugins-inputs-jms-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-jms.md#plugins-inputs-jms-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-jms.md#plugins-inputs-jms-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-jms.md#plugins-inputs-jms-type) | [string](value-types.md#string) | No |
