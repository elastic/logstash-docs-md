...
If you are shipping events that span multiple lines, you need to use the [configuration options available in Filebeat](https://www.elastic.co/guide/en/beats/filebeat/current/multiline-examples.html) to handle multiline events before sending the event data to Logstash. You cannot use the [Multiline codec plugin](plugins-codecs-multiline.md) to handle multiline events. Doing so will result in the failure to start Logstash.
...
This configuration results in daily index names like `filebeat-9.0.0-2025-03-21`.
...
| --- | --- | --- |
| [`add_hostname`](plugins-inputs-beats.md#plugins-inputs-beats-add_hostname) | [boolean](introduction.md#boolean) | *Deprecated* |
| [`client_inactivity_timeout`](plugins-inputs-beats.md#plugins-inputs-beats-client_inactivity_timeout) | [number](introduction.md#number) | No |
| [`ecs_compatibility`](plugins-inputs-beats.md#plugins-inputs-beats-ecs_compatibility) | [string](introduction.md#string) | No |
| [`enrich`](plugins-inputs-beats.md#plugins-inputs-beats-enrich) | [string](introduction.md#string) | No |
| [`event_loop_threads`](plugins-inputs-beats.md#plugins-inputs-beats-event_loop_threads) | [number](introduction.md#number) | No |
| [`executor_threads`](plugins-inputs-beats.md#plugins-inputs-beats-executor_threads) | [number](introduction.md#number) | No |
| [`host`](plugins-inputs-beats.md#plugins-inputs-beats-host) | [string](introduction.md#string) | No |
| [`include_codec_tag`](plugins-inputs-beats.md#plugins-inputs-beats-include_codec_tag) | [boolean](introduction.md#boolean) | *Deprecated* |
| [`port`](plugins-inputs-beats.md#plugins-inputs-beats-port) | [number](introduction.md#number) | Yes |
| [`ssl_certificate`](plugins-inputs-beats.md#plugins-inputs-beats-ssl_certificate) | a valid filesystem path | No |
| [`ssl_certificate_authorities`](plugins-inputs-beats.md#plugins-inputs-beats-ssl_certificate_authorities) | [array](introduction.md#array) | No |
| [`ssl_cipher_suites`](plugins-inputs-beats.md#plugins-inputs-beats-ssl_cipher_suites) | [array](introduction.md#array) | No |
| [`ssl_client_authentication`](plugins-inputs-beats.md#plugins-inputs-beats-ssl_client_authentication) | [string](introduction.md#string), one of `["none", "optional", "required"]` | No |
| [`ssl_enabled`](plugins-inputs-beats.md#plugins-inputs-beats-ssl_enabled) | [boolean](introduction.md#boolean) | No |
| [`ssl_handshake_timeout`](plugins-inputs-beats.md#plugins-inputs-beats-ssl_handshake_timeout) | [number](introduction.md#number) | No |
| [`ssl_key`](plugins-inputs-beats.md#plugins-inputs-beats-ssl_key) | a valid filesystem path | No |
| [`ssl_key_passphrase`](plugins-inputs-beats.md#plugins-inputs-beats-ssl_key_passphrase) | [password](introduction.md#password) | No |
| [`ssl_supported_protocols`](plugins-inputs-beats.md#plugins-inputs-beats-ssl_supported_protocols) | [array](introduction.md#array) | No |
