...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-jdbc_static-index.html).
...
* **lookups**
  ...
  2. Defines the columns, types, and indexes used to build the local database structure. The column names and types should match the external database. The order of table definitions is significant and should match that of the loader queries. See [Loader column and local\_db\_object order dependency](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-object_order).
...
This plugin is compatible with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/8.17). It behaves the same regardless of ECS compatibility, except giving a warning when ECS is enabled and `target` isn’t set.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-remove_tag) | [array](value-types.md#array) | No |
