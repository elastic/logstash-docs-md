...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-prune-index.html).
...
This can e.g. be useful if you have a [json](https://www.elastic.co/guide/en/logstash/8.18/plugins-filters-json.html) or [kv](https://www.elastic.co/guide/en/logstash/8.18/plugins-filters-kv.html) filter that creates a number of fields with names that you don’t necessarily know the names of beforehand, and you only want to keep a subset of them.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-prune.md#plugins-filters-prune-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-prune.md#plugins-filters-prune-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-prune.md#plugins-filters-prune-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-prune.md#plugins-filters-prune-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-prune.md#plugins-filters-prune-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-prune.md#plugins-filters-prune-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-prune.md#plugins-filters-prune-remove_tag) | [array](value-types.md#array) | No |
