...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/input-graphite-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-graphite.md#plugins-inputs-graphite-add_field) | [hash](value-types.md#hash) | No |
| [`codec`](plugins-inputs-graphite.md#plugins-inputs-graphite-codec) | [codec](value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-graphite.md#plugins-inputs-graphite-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-inputs-graphite.md#plugins-inputs-graphite-id) | [string](value-types.md#string) | No |
| [`tags`](plugins-inputs-graphite.md#plugins-inputs-graphite-tags) | [array](value-types.md#array) | No |
| [`type`](plugins-inputs-graphite.md#plugins-inputs-graphite-type) | [string](value-types.md#string) | No |
