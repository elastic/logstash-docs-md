...
For other versions, see the [Versioned plugin docs](/vpr/input-graphite-index.md).
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](plugins-inputs-graphite.md#plugins-inputs-graphite-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`codec`](plugins-inputs-graphite.md#plugins-inputs-graphite-codec) | [codec](logstash://reference/configuration-file-structure.md#codec) | No |
| [`enable_metric`](plugins-inputs-graphite.md#plugins-inputs-graphite-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](plugins-inputs-graphite.md#plugins-inputs-graphite-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`tags`](plugins-inputs-graphite.md#plugins-inputs-graphite-tags) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`type`](plugins-inputs-graphite.md#plugins-inputs-graphite-type) | [string](logstash://reference/configuration-file-structure.md#string) | No |
