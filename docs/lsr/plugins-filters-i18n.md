...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-i18n-index.html).

## Installation [_installation_61]

For plugins not bundled by default, it is easy to install by running `bin/logstash-plugin install logstash-filter-i18n`. See [Working with plugins](https://www.elastic.co/guide/en/logstash/8.18/working-with-plugins.html) for more details.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-i18n.md#plugins-filters-i18n-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-i18n.md#plugins-filters-i18n-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-i18n.md#plugins-filters-i18n-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-i18n.md#plugins-filters-i18n-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-i18n.md#plugins-filters-i18n-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-i18n.md#plugins-filters-i18n-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-i18n.md#plugins-filters-i18n-remove_tag) | [array](value-types.md#array) | No |
