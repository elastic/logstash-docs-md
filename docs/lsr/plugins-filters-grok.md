...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-grok-index.html).
...
The [`dissect`](https://www.elastic.co/guide/en/logstash/8.18/plugins-filters-dissect.html) filter plugin is another way to extract unstructured event data into fields using delimiters.
...
To ease migration to the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/8.17), the filter plugin offers a new set of ECS-compliant patterns in addition to the existing patterns. The new ECS pattern definitions capture event field names that are compliant with the schema.
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/8.17). The value of this setting affects extracted event field names when a composite pattern (such as `HTTPD_COMMONLOG`) is matched.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-grok.md#plugins-filters-grok-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-grok.md#plugins-filters-grok-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-grok.md#plugins-filters-grok-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-grok.md#plugins-filters-grok-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-grok.md#plugins-filters-grok-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-grok.md#plugins-filters-grok-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-grok.md#plugins-filters-grok-remove_tag) | [array](value-types.md#array) | No |
