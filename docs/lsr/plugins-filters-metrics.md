...
For other versions, see the [Versioned plugin docs](https://www.elastic.co/guide/en/logstash-versioned-plugins/current/filter-metrics-index.html).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-metrics.md#plugins-filters-metrics-add_field) | [hash](value-types.md#hash) | No |
| [`add_tag`](plugins-filters-metrics.md#plugins-filters-metrics-add_tag) | [array](value-types.md#array) | No |
| [`enable_metric`](plugins-filters-metrics.md#plugins-filters-metrics-enable_metric) | [boolean](value-types.md#boolean) | No |
| [`id`](plugins-filters-metrics.md#plugins-filters-metrics-id) | [string](value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-metrics.md#plugins-filters-metrics-periodic_flush) | [boolean](value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-metrics.md#plugins-filters-metrics-remove_field) | [array](value-types.md#array) | No |
| [`remove_tag`](plugins-filters-metrics.md#plugins-filters-metrics-remove_tag) | [array](value-types.md#array) | No |
