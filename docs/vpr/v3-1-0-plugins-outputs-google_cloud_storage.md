...
This plugin supports the following configuration options plus the [Common options](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`bucket`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-bucket "bucket") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`date_pattern`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-date_pattern "date_pattern") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`flush_interval_secs`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-flush_interval_secs "flush_interval_secs") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`gzip`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-gzip "gzip") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_hostname`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-include_hostname "include_hostname") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_uuid`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-include_uuid "include_uuid") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`key_password`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-key_password "key_password") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`key_path`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-key_path "key_path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`log_file_prefix`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-log_file_prefix "log_file_prefix") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`max_file_size_kbytes`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-max_file_size_kbytes "max_file_size_kbytes") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`output_format`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-output_format "output_format") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["json", "plain"]` | No |
| [`service_account`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-service_account "service_account") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`temp_directory`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-temp_directory "temp_directory") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`uploader_interval_secs`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-uploader_interval_secs "uploader_interval_secs") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-0-plugins-outputs-google_cloud_storage.md#v3.1.0-plugins-outputs-google_cloud_storage-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
