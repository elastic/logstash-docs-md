...
| :- | :- | :- |
| [`emit_hosts`](v0-0-20-plugins-codecs-nmap.md#v0.0.20-plugins-codecs-nmap-emit_hosts "emit_hosts") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`emit_ports`](v0-0-20-plugins-codecs-nmap.md#v0.0.20-plugins-codecs-nmap-emit_ports "emit_ports") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`emit_scan_metadata`](v0-0-20-plugins-codecs-nmap.md#v0.0.20-plugins-codecs-nmap-emit_scan_metadata "emit_scan_metadata") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`emit_traceroute_links`](v0-0-20-plugins-codecs-nmap.md#v0.0.20-plugins-codecs-nmap-emit_traceroute_links "emit_traceroute_links") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
