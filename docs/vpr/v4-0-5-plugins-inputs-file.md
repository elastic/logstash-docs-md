...
This plugin supports the following configuration options plus the [Common options](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`close_older`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-close_older "close_older") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`delimiter`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-delimiter "delimiter") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`discover_interval`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-discover_interval "discover_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`exclude`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-exclude "exclude") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ignore_older`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-ignore_older "ignore_older") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`max_open_files`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-max_open_files "max_open_files") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`path`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-path "path") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes |
| [`sincedb_path`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-sincedb_path "sincedb_path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`sincedb_write_interval`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-sincedb_write_interval "sincedb_write_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`start_position`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-start_position "start_position") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["beginning", "end"]` | No |
| [`stat_interval`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-stat_interval "stat_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v4-0-5-plugins-inputs-file.md#v4.0.5-plugins-inputs-file-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
