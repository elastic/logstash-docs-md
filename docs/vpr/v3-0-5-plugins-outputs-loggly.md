...
This plugin supports the following configuration options plus the [Common options](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`can_retry`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-can_retry "can_retry") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`host`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`key`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-key "key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`proto`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-proto "proto") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`proxy_host`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-proxy_host "proxy_host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`proxy_password`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-proxy_password "proxy_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`proxy_port`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-proxy_port "proxy_port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`proxy_user`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-proxy_user "proxy_user") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`retry_count`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-retry_count "retry_count") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`tag`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-tag "tag") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-5-plugins-outputs-loggly.md#v3.0.5-plugins-outputs-loggly-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
