...
This plugin supports the following configuration options plus the [Common options](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`create_if_deleted`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-create_if_deleted "create_if_deleted") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`csv_options`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-csv_options "csv_options") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`dir_mode`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-dir_mode "dir_mode") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`fields`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-fields "fields") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes |
| [`file_mode`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-file_mode "file_mode") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`filename_failure`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-filename_failure "filename_failure") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`flush_interval`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-flush_interval "flush_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`gzip`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-gzip "gzip") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`path`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-path "path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`spreadsheet_safe`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-spreadsheet_safe "spreadsheet_safe") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |

Also see [Common options](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-8-plugins-outputs-csv.md#v3.0.8-plugins-outputs-csv-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
