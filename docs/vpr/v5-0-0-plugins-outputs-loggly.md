...
| [`retry_count`](v5-0-0-plugins-outputs-loggly.md#v5.0.0-plugins-outputs-loggly-retry_count) | [number](logstash://reference/configuration-file-structure.md#number) | No |
