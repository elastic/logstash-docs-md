...
| [`http_compression`](v5-2-5-plugins-outputs-http.md#v5.2.5-plugins-outputs-http-http_compression) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
