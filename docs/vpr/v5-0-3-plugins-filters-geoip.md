...
This plugin supports the following configuration options plus the [Common options](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`cache_size`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-cache_size "cache_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`database`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-database "database") | a valid filesystem path | No |
| [`default_database_type`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-default_database_type "default_database_type") | `City` or `ASN` | No |
| [`fields`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-fields "fields") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`source`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-source "source") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`tag_on_failure`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-tag_on_failure "tag_on_failure") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`target`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v5-0-3-plugins-filters-geoip.md#v5.0.3-plugins-filters-geoip-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
