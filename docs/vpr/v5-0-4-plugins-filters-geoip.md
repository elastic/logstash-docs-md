...
| --- | --- | --- |
| [`cache_size`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-cache_size) | [number](logstash://reference/configuration-file-structure.md#number) | No |
...
| [`fields`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-fields) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`source`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-source) | [string](logstash://reference/configuration-file-structure.md#string) | Yes |
| [`tag_on_failure`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-tag_on_failure) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`target`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-target) | [string](logstash://reference/configuration-file-structure.md#string) | No |
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`add_tag`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-add_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`enable_metric`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`periodic_flush`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-periodic_flush) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`remove_field`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-remove_field) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`remove_tag`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-remove_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
