...
| --- | --- | --- |
| [`source`](v3-0-1-plugins-filters-extractnumbers.md#v3.0.1-plugins-filters-extractnumbers-source) | [string](logstash://reference/configuration-file-structure.md#string) | No |
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](v3-0-1-plugins-filters-extractnumbers.md#v3.0.1-plugins-filters-extractnumbers-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`add_tag`](v3-0-1-plugins-filters-extractnumbers.md#v3.0.1-plugins-filters-extractnumbers-add_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`enable_metric`](v3-0-1-plugins-filters-extractnumbers.md#v3.0.1-plugins-filters-extractnumbers-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](v3-0-1-plugins-filters-extractnumbers.md#v3.0.1-plugins-filters-extractnumbers-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`periodic_flush`](v3-0-1-plugins-filters-extractnumbers.md#v3.0.1-plugins-filters-extractnumbers-periodic_flush) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`remove_field`](v3-0-1-plugins-filters-extractnumbers.md#v3.0.1-plugins-filters-extractnumbers-remove_field) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`remove_tag`](v3-0-1-plugins-filters-extractnumbers.md#v3.0.1-plugins-filters-extractnumbers-remove_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
