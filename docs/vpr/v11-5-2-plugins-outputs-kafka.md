...
| [`receive_buffer_bytes`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-receive_buffer_bytes) | [number](logstash://reference/configuration-file-structure.md#number) | No |
