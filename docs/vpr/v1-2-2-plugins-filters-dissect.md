...
## Getting help [_getting_help_1750]
...
| --- | --- | --- |
| [`convert_datatype`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-convert_datatype) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`mapping`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-mapping) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`tag_on_failure`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-tag_on_failure) | [array](logstash://reference/configuration-file-structure.md#array) | No |
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`add_tag`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-add_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`enable_metric`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`periodic_flush`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-periodic_flush) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`remove_field`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-remove_field) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`remove_tag`](v1-2-2-plugins-filters-dissect.md#v1.2.2-plugins-filters-dissect-remove_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
