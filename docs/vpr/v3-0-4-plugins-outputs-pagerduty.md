...
This plugin supports the following configuration options plus the [Common options](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`description`](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-description "description") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`details`](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-details "details") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`event_type`](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-event_type "event_type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["trigger", "acknowledge", "resolve"]` | No |
| [`incident_key`](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-incident_key "incident_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`pdurl`](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-pdurl "pdurl") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`service_key`](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-service_key "service_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |

Also see [Common options](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-4-plugins-outputs-pagerduty.md#v3.0.4-plugins-outputs-pagerduty-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
