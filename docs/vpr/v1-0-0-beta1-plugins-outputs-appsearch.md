...
For other versions, see the [overview list](output-appsearch-index.md "Versioned appsearch output plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`api_key`](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-api_key "api_key") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | Yes |
| [`document_id`](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-document_id "document_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`engine`](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-engine "engine") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`host`](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`timestamp_destination`](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-timestamp_destination "timestamp_destination") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v1-0-0-beta1-plugins-outputs-appsearch.md#v1.0.0.beta1-plugins-outputs-appsearch-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
