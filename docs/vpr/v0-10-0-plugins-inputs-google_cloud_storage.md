...
This plugin supports the following configuration options plus the [Common options](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`bucket_id`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-bucket_id "bucket_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`json_key_file`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-json_key_file "json_key_file") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`interval`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-interval "interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`file_matches`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-file_matches "file_matches") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`file_exclude`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-file_exclude "file_exclude") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`metadata_key`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-metadata_key "metadata_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`processed_db_path`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-processed_db_path "processed_db_path") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`delete`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-delete "delete") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`unpack_gzip`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-unpack_gzip "unpack_gzip") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |

Also see [Common options](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v0-10-0-plugins-inputs-google_cloud_storage.md#v0.10.0-plugins-inputs-google_cloud_storage-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
