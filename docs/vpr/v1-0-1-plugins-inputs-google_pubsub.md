...
This plugin supports the following configuration options plus the [Common options](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`json_key_file`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-json_key_file "json_key_file") | a valid filesystem path | No |
| [`max_messages`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-max_messages "max_messages") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | Yes |
| [`project_id`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-project_id "project_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`subscription`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-subscription "subscription") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`topic`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-topic "topic") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |

Also see [Common options](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v1-0-1-plugins-inputs-google_pubsub.md#v1.0.1-plugins-inputs-google_pubsub-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
