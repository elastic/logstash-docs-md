...
For other versions, see the [overview list](input-elastic_serverless_forwarder-index.md "Versioned elastic_serverless_forwarder input plugin docs").

To learn more about Logstash, see the [Logstash Reference](https://www.elastic.co/guide/en/logstash/current/index.html).

### Getting help [_getting_help_309]
...
Using this input you can receive events from Elastic Serverless Forwarder over http(s) connections to the configured [`port`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-port "port").
...
In order to establish SSL with a client, this input plugin will need to present an SSL certificate that the client trusts, and have access to the associated key. These are configurable with [`ssl_certificate`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_certificate "ssl_certificate"), [`ssl_key`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_key "ssl_key"), and optionally [`ssl_key_passphrase`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_key_passphrase "ssl_key_passphrase").
...
It can be configured to either request or require client certificates using [`ssl_client_authentication`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_client_authentication "ssl_client_authentication"), which often also requires configuring it with a list of [`ssl_certificate_authorities`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_certificate_authorities "ssl_certificate_authorities") to trust. When validating a certificate that is presented, [`ssl_verification_mode`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_verification_mode "ssl_verification_mode") controls how certificates are verified.
...
* [`ssl_cipher_suites`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_cipher_suites "ssl_cipher_suites")
* [`ssl_supported_protocols`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_supported_protocols "ssl_supported_protocols")
* [`ssl_handshake_timeout`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_handshake_timeout "ssl_handshake_timeout")

#### HTTP Basic Authentication [_http_basic_authentication]

You can configure this plugin to authenticate requests using HTTP Basic authentication by configuring [`auth_basic_username`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-auth_basic_username "auth_basic_username") and [`auth_basic_password`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-auth_basic_password "auth_basic_password").
...
This plugin supports the following configuration options plus the [Common options](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`auth_basic_username`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-auth_basic_username "auth_basic_username") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`auth_basic_password`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-auth_basic_password "auth_basic_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`host`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`port`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`ssl`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl "ssl") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | *Deprecated* |
| [`ssl_certificate`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_certificate "ssl_certificate") | a valid filesystem path | No |
| [`ssl_certificate_authorities`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_certificate_authorities "ssl_certificate_authorities") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl_client_authentication`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_client_authentication "ssl_client_authentication") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["none", "optional", "required"]` | No |
| [`ssl_cipher_suites`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_cipher_suites "ssl_cipher_suites") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl_enabled`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_enabled "ssl_enabled") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`ssl_handshake_timeout`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_handshake_timeout "ssl_handshake_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`ssl_key`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_key "ssl_key") | a valid filesystem path | No |
| [`ssl_key_passphrase`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_key_passphrase "ssl_key_passphrase") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`ssl_supported_protocols`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_supported_protocols "ssl_supported_protocols") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl_verification_mode`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_verification_mode "ssl_verification_mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["certificate"]` | No |

Also see [Common options](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-common-options "Common options") for a list of options supported by all input plugins.
...
Password for HTTP basic authorization. Requires [`auth_basic_username`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-auth_basic_username "auth_basic_username").
...
Username for basic authorization. Requires [`auth_basic_password`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-auth_basic_password "auth_basic_password").
...
Replaced by [`ssl_enabled`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_enabled "ssl_enabled")

* Value type is [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean)
* Default value is `true`

Events are by default sent over SSL, which requires configuring this plugin to present an identity certificate using [`ssl_certificate`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_certificate "ssl_certificate") and key using [`ssl_key`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_key "ssl_key").
...
When [`ssl_client_authentication`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-ssl_client_authentication "ssl_client_authentication") causes a client to present a certificate, this setting controls how that certificate is verified.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`enable_metric`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v0-1-5-plugins-inputs-elastic_serverless_forwarder.md#v0.1.5-plugins-inputs-elastic_serverless_forwarder-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
