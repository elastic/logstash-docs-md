...
This plugin supports the following configuration options plus the [Common options](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`csv_schema`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-csv_schema "csv_schema") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`dataset`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-dataset "dataset") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`date_pattern`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-date_pattern "date_pattern") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`deleter_interval_secs`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-deleter_interval_secs "deleter_interval_secs") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`flush_interval_secs`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-flush_interval_secs "flush_interval_secs") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`ignore_unknown_values`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-ignore_unknown_values "ignore_unknown_values") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`json_schema`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-json_schema "json_schema") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`key_password`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-key_password "key_password") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`key_path`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-key_path "key_path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`project_id`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-project_id "project_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`service_account`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-service_account "service_account") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`table_prefix`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-table_prefix "table_prefix") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`table_separator`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-table_separator "table_separator") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`temp_directory`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-temp_directory "temp_directory") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`temp_file_prefix`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-temp_file_prefix "temp_file_prefix") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`uploader_interval_secs`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-uploader_interval_secs "uploader_interval_secs") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-2-3-plugins-outputs-google_bigquery.md#v3.2.3-plugins-outputs-google_bigquery-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
