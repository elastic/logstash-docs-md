...
This plugin supports the following configuration options plus the [Common options](v3-0-4-plugins-outputs-websocket.md#v3.0.4-plugins-outputs-websocket-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`host`](v3-0-4-plugins-outputs-websocket.md#v3.0.4-plugins-outputs-websocket-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`port`](v3-0-4-plugins-outputs-websocket.md#v3.0.4-plugins-outputs-websocket-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v3-0-4-plugins-outputs-websocket.md#v3.0.4-plugins-outputs-websocket-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-4-plugins-outputs-websocket.md#v3.0.4-plugins-outputs-websocket-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-4-plugins-outputs-websocket.md#v3.0.4-plugins-outputs-websocket-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-4-plugins-outputs-websocket.md#v3.0.4-plugins-outputs-websocket-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
