...
This plugin supports the following configuration options plus the [Common options](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`autodetect_column_names`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-autodetect_column_names "autodetect_column_names") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`autogenerate_column_names`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-autogenerate_column_names "autogenerate_column_names") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`columns`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-columns "columns") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`convert`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-convert "convert") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`quote_char`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-quote_char "quote_char") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`separator`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-separator "separator") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`skip_empty_columns`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-skip_empty_columns "skip_empty_columns") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`skip_empty_rows`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-skip_empty_rows "skip_empty_rows") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`skip_header`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-skip_header "skip_header") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`source`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-source "source") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`target`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-0-10-plugins-filters-csv.md#v3.0.10-plugins-filters-csv-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
