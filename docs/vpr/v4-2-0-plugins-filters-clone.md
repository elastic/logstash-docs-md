...
This plugin supports the following configuration options plus the [Common options](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`clones`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-clones "clones") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes |
| [`ecs_compatibility`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-common-options "Common options") for a list of options supported by all filter plugins.
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the behavior of the [`clones`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-clones "clones")
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
