...
This plugin supports the following configuration options plus the [Common options](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`host`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`port`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`remap`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-remap "remap") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`strip_leading_underscore`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-strip_leading_underscore "strip_leading_underscore") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |

Also see [Common options](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v3-0-4-plugins-inputs-gelf.md#v3.0.4-plugins-inputs-gelf-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
