...
For other versions, see the [overview list](output-timber-index.md "Versioned timber output plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`api_key`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-api_key "api_key") | Your Timber.io API key | No |
| [`cacert`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-cacert "cacert") | a valid filesystem path | No |
| [`client_cert`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-client_cert "client_cert") | a valid filesystem path | No |
| [`client_key`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-client_key "client_key") | a valid filesystem path | No |
| [`connect_timeout`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-connect_timeout "connect_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`keystore`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-keystore "keystore") | a valid filesystem path | No |
| [`keystore_password`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-keystore_password "keystore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`keystore_type`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-keystore_type "keystore_type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`pool_max`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-pool_max "pool_max") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`proxy`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-proxy "proxy") | <<,>> | No |
| [`request_timeout`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-request_timeout "request_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`socket_timeout`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-socket_timeout "socket_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`truststore`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-truststore "truststore") | a valid filesystem path | No |
| [`truststore_password`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-truststore_password "truststore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`truststore_type`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-truststore_type "truststore_type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v1-0-3-plugins-outputs-timber.md#v1.0.3-plugins-outputs-timber-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
