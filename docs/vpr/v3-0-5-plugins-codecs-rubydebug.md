...
| :- | :- | :- |
| [`metadata`](v3-0-5-plugins-codecs-rubydebug.md#v3.0.5-plugins-codecs-rubydebug-metadata "metadata") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
