...
| [`include_codec_tag`](v6-7-1-plugins-inputs-beats.md#v6.7.1-plugins-inputs-beats-include_codec_tag) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | *Deprecated* |
