...
This plugin supports the following configuration options plus the [Common options](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`ecs_compatibility`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`get`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-get "get") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`hosts`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-hosts "hosts") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`interval`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-interval "interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`local_engine_id`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-local_engine_id "local_engine_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`mib_paths`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-mib_paths "mib_paths") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`oid_mapping_format`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_mapping_format "oid_mapping_format") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["default", "ruby_snmp", "dotted_string"]` | No |
| [`oid_map_field_values`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_map_field_values "oid_map_field_values") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`oid_path_length`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_path_length "oid_path_length") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`oid_root_skip`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_root_skip "oid_root_skip") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`poll_hosts_timeout`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-poll_hosts_timeout "poll_hosts_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`walk`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-walk "walk") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`tables`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-tables "tables") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`target`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`threads`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-threads "threads") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`use_provided_mibs`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-use_provided_mibs "use_provided_mibs") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`auth_pass`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-auth_pass "auth_pass") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`auth_protocol`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-auth_protocol "auth_protocol") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["md5", "sha", "sha2", "hmac128sha224", "hmac192sha256", "hmac256sha384", "hmac384sha512"]` | No |
| [`priv_pass`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-priv_pass "priv_pass") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`priv_protocol`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-priv_protocol "priv_protocol") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["des", "3des", "aes", "aes128", "aes192", "aes256"]` | No |
| [`security_level`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-security_level "security_level") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["noAuthNoPriv", "authNoPriv", "authPriv"]` | No |
| [`security_name`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-security_name "security_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

### SNMP Input Configuration Options [_snmp_input_configuration_options_6]

Also see [Common options](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-common-options "Common options") for a list of options supported by all input plugins.
...
This plugin includes the IETF MIBs. If you require other MIBs, you need to import them. See [Importing MIBs](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-import-mibs "Importing MIBs").
...
Defines if the Logstash event fields values, which types are `OID`, are mapped using the configured OID textual representation set on the [`oid_mapping_format`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_mapping_format "oid_mapping_format") option.
...
* You can use this setting or [`oid_path_length`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_path_length "oid_path_length"), but not both at the same time.
* Use this setting only if [`oid_mapping_format`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_mapping_format "oid_mapping_format") is set to `default`.
...
* You can use this setting or [`oid_root_skip`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_root_skip "oid_root_skip"), but not both at the same time.
* This setting can be used only if [`oid_mapping_format`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_mapping_format "oid_mapping_format") is set to `default`.
...
Specifies the maximum amount of time in milliseconds the polling client will wait for all [`hosts`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-hosts "hosts") responses. If all responses are not received before the timeout elapses, the client will fail and some hosts might not get polled during the current cycle.

By default, it uses the highest value between `1 hour`, the maximum [`hosts`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-hosts "hosts") configured `timeout`, and the [`interval`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-interval "interval") value.
...
Setting a target is recommended when [`ecs_compatibility`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-ecs_compatibility "ecs_compatibility") is enabled.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`enable_metric`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
