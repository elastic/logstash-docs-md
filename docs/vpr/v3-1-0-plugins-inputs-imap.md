...
| [`strip_attachments`](v3-1-0-plugins-inputs-imap.md#v3.1.0-plugins-inputs-imap-strip_attachments) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
