...
This plugin supports the following configuration options plus the [Common options](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`cache_size`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-cache_size "cache_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`database`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-database "database") | a valid filesystem path | No |
| [`default_database_type`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-default_database_type "default_database_type") | `City` or `ASN` | No |
| [`ecs_compatibility`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`fields`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-fields "fields") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`source`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-source "source") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`tag_on_failure`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-tag_on_failure "tag_on_failure") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`target`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-common-options "Common options") for a list of options supported by all filter plugins.
...
Database auto-update applies to default distribution. When `database` points to user’s database path, auto-update will be disabled. See [Database License](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-database_license "Database License") for more information.
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the *default* value of [`target`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-target "target").
...
* Default value depends on whether [`ecs_compatibility`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-ecs_compatibility "ecs_compatibility") is enabled:
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v7-2-3-plugins-filters-geoip.md#v7.2.3-plugins-filters-geoip-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
