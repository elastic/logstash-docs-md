...
| :- | :- | :- |
| [`authfile`](v3-0-4-plugins-codecs-collectd.md#v3.0.4-plugins-codecs-collectd-authfile "authfile") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`nan_handling`](v3-0-4-plugins-codecs-collectd.md#v3.0.4-plugins-codecs-collectd-nan_handling "nan_handling") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["change_value", "warn", "drop"]` | No |
| [`nan_tag`](v3-0-4-plugins-codecs-collectd.md#v3.0.4-plugins-codecs-collectd-nan_tag "nan_tag") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`nan_value`](v3-0-4-plugins-codecs-collectd.md#v3.0.4-plugins-codecs-collectd-nan_value "nan_value") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`prune_intervals`](v3-0-4-plugins-codecs-collectd.md#v3.0.4-plugins-codecs-collectd-prune_intervals "prune_intervals") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`security_level`](v3-0-4-plugins-codecs-collectd.md#v3.0.4-plugins-codecs-collectd-security_level "security_level") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["None", "Sign", "Encrypt"]` | No |
| [`typesdb`](v3-0-4-plugins-codecs-collectd.md#v3.0.4-plugins-codecs-collectd-typesdb "typesdb") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
