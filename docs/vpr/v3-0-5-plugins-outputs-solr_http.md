...
For other versions, see the [overview list](output-solr_http-index.md "Versioned solr_http output plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v3-0-5-plugins-outputs-solr_http.md#v3.0.5-plugins-outputs-solr_http-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`document_id`](v3-0-5-plugins-outputs-solr_http.md#v3.0.5-plugins-outputs-solr_http-document_id "document_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`flush_size`](v3-0-5-plugins-outputs-solr_http.md#v3.0.5-plugins-outputs-solr_http-flush_size "flush_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`idle_flush_time`](v3-0-5-plugins-outputs-solr_http.md#v3.0.5-plugins-outputs-solr_http-idle_flush_time "idle_flush_time") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`solr_url`](v3-0-5-plugins-outputs-solr_http.md#v3.0.5-plugins-outputs-solr_http-solr_url "solr_url") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-0-5-plugins-outputs-solr_http.md#v3.0.5-plugins-outputs-solr_http-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-5-plugins-outputs-solr_http.md#v3.0.5-plugins-outputs-solr_http-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-5-plugins-outputs-solr_http.md#v3.0.5-plugins-outputs-solr_http-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-5-plugins-outputs-solr_http.md#v3.0.5-plugins-outputs-solr_http-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
