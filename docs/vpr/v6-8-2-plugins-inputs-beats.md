...
When decoding Beats events, this plugin enriches each event with metadata about the event’s source, making this information available during further processing. You can use the [`enrich`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-enrich "enrich") option to activate or deactivate individual enrichment categories.

The location of these enrichment fields depends on whether [ECS compatibility mode](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ecs_compatibility "ecs_compatibility") is enabled:
...
This plugin supports the following configuration options plus the [Common options](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_hostname`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-add_hostname "add_hostname") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | *Deprecated* |
| [`cipher_suites`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-cipher_suites "cipher_suites") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | *Deprecated* |
| [`client_inactivity_timeout`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-client_inactivity_timeout "client_inactivity_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`ecs_compatibility`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`enrich`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-enrich "enrich") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`event_loop_threads`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-event_loop_threads "event_loop_threads") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`executor_threads`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-executor_threads "executor_threads") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`host`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`include_codec_tag`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-include_codec_tag "include_codec_tag") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | *Deprecated* |
| [`port`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | Yes |
| [`ssl`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl "ssl") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | *Deprecated* |
| [`ssl_certificate`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_certificate "ssl_certificate") | a valid filesystem path | No |
| [`ssl_certificate_authorities`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_certificate_authorities "ssl_certificate_authorities") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl_cipher_suites`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_cipher_suites "ssl_cipher_suites") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl_client_authentication`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_client_authentication "ssl_client_authentication") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["none", "optional", "required"]` | No |
| [`ssl_enabled`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_enabled "ssl_enabled") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`ssl_handshake_timeout`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_handshake_timeout "ssl_handshake_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`ssl_key`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_key "ssl_key") | a valid filesystem path | No |
| [`ssl_key_passphrase`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_key_passphrase "ssl_key_passphrase") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`ssl_peer_metadata`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_peer_metadata "ssl_peer_metadata") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | *Deprecated* |
| [`ssl_supported_protocols`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_supported_protocols "ssl_supported_protocols") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl_verify_mode`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_verify_mode "ssl_verify_mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["none", "peer", "force_peer"]` | *Deprecated* |
| [`tls_max_version`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-tls_max_version "tls_max_version") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | *Deprecated* |
| [`tls_min_version`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-tls_min_version "tls_min_version") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | *Deprecated* |

Also see [Common options](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-common-options "Common options") for a list of options supported by all input plugins.
...
Replaced by [`ssl_cipher_suites`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_cipher_suites "ssl_cipher_suites")
...
Refer to [ECS mapping](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ecs_metadata "Event enrichment and the Elastic Common Schema (ECS)") for detailed information.
...
Replaced by [`enrich`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-enrich "enrich")
...
Replaced by [`ssl_enabled`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_enabled "ssl_enabled")
...
When mutual TLS is enabled (`required` or `optional`), the certificate presented by the client must be signed by trusted [`ssl_certificate_authorities`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_certificate_authorities "ssl_certificate_authorities") (CAs). Please note that the server does not validate the client certificate CN (Common Name) or SAN (Subject Alternative Name).

This setting can be used only if [`ssl_certificate_authorities`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_certificate_authorities "ssl_certificate_authorities") is set.
...
Events are by default sent in plain text. You can enable encryption by setting `ssl_enabled` to true and configuring the [`ssl_certificate`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_certificate "ssl_certificate") and [`ssl_key`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_key "ssl_key") options.
...
This option is only valid when [`ssl_client_authentication`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_client_authentication "ssl_client_authentication") is set to `optional` or `required`.
...
Replaced by [`ssl_client_authentication`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_client_authentication "ssl_client_authentication")

* Value can be any of: `none`, `peer`, `force_peer`
* Default value is `"none"`

By default, the server doesn’t do any client verification. If the [`ssl_certificate_authorities`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_certificate_authorities "ssl_certificate_authorities") is configured, and no value or `none` is provided for this option, it defaults to `force_peer` instead of `none`.
...
Replaced by [`ssl_supported_protocols`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-ssl_supported_protocols "ssl_supported_protocols")
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
...
The Beats shipper automatically sets the `type` field on the event. You cannot override this setting in the Logstash config. If you specify a setting for the [`type`](v6-8-2-plugins-inputs-beats.md#v6.8.2-plugins-inputs-beats-type "type") config option in Logstash, it is ignored.
