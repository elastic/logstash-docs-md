...
This plugin supports the following configuration options plus the [Common options](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`api_version`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-api_version "api_version") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`client_id`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-client_id "client_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`client_secret`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-client_secret "client_secret") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`password`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-password "password") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`security_token`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-security_token "security_token") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`sfdc_fields`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-sfdc_fields "sfdc_fields") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`sfdc_filters`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-sfdc_filters "sfdc_filters") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`sfdc_object_name`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-sfdc_object_name "sfdc_object_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`to_underscores`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-to_underscores "to_underscores") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`use_test_sandbox`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-use_test_sandbox "use_test_sandbox") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`username`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-username "username") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |

Also see [Common options](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v3-0-6-plugins-inputs-salesforce.md#v3.0.6-plugins-inputs-salesforce-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
