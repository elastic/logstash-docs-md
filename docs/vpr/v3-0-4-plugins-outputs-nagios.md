...
For other versions, see the [overview list](output-nagios-index.md "Versioned nagios output plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v3-0-4-plugins-outputs-nagios.md#v3.0.4-plugins-outputs-nagios-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`commandfile`](v3-0-4-plugins-outputs-nagios.md#v3.0.4-plugins-outputs-nagios-commandfile "commandfile") | <<,>> | No |
| [`nagios_level`](v3-0-4-plugins-outputs-nagios.md#v3.0.4-plugins-outputs-nagios-nagios_level "nagios_level") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["0", "1", "2", "3"]` | No |

Also see [Common options](v3-0-4-plugins-outputs-nagios.md#v3.0.4-plugins-outputs-nagios-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-4-plugins-outputs-nagios.md#v3.0.4-plugins-outputs-nagios-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-4-plugins-outputs-nagios.md#v3.0.4-plugins-outputs-nagios-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-4-plugins-outputs-nagios.md#v3.0.4-plugins-outputs-nagios-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
