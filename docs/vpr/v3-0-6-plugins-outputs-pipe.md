...
This plugin supports the following configuration options plus the [Common options](v3-0-6-plugins-outputs-pipe.md#v3.0.6-plugins-outputs-pipe-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`command`](v3-0-6-plugins-outputs-pipe.md#v3.0.6-plugins-outputs-pipe-command "command") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`message_format`](v3-0-6-plugins-outputs-pipe.md#v3.0.6-plugins-outputs-pipe-message_format "message_format") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`ttl`](v3-0-6-plugins-outputs-pipe.md#v3.0.6-plugins-outputs-pipe-ttl "ttl") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v3-0-6-plugins-outputs-pipe.md#v3.0.6-plugins-outputs-pipe-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-6-plugins-outputs-pipe.md#v3.0.6-plugins-outputs-pipe-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-6-plugins-outputs-pipe.md#v3.0.6-plugins-outputs-pipe-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-6-plugins-outputs-pipe.md#v3.0.6-plugins-outputs-pipe-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
