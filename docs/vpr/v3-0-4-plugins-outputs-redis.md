...
| [`reconnect_interval`](v3-0-4-plugins-outputs-redis.md#v3.0.4-plugins-outputs-redis-reconnect_interval) | [number](logstash://reference/configuration-file-structure.md#number) | No |
