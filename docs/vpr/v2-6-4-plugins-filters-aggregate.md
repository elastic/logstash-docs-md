...
This plugin supports the following configuration options plus the [Common options](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`aggregate_maps_path`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-aggregate_maps_path "aggregate_maps_path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), a valid filesystem path | No |
| [`code`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-code "code") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`end_of_task`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-end_of_task "end_of_task") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`inactivity_timeout`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-inactivity_timeout "inactivity_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`map_action`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-map_action "map_action") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["create", "update", "create_or_update"]` | No |
| [`push_map_as_event_on_timeout`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-push_map_as_event_on_timeout "push_map_as_event_on_timeout") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`push_previous_map_as_event`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-push_previous_map_as_event "push_previous_map_as_event") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`task_id`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-task_id "task_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`timeout`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-timeout "timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`timeout_code`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-timeout_code "timeout_code") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`timeout_tags`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-timeout_tags "timeout_tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`timeout_task_id_field`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-timeout_task_id_field "timeout_task_id_field") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v2-6-4-plugins-filters-aggregate.md#v2.6.4-plugins-filters-aggregate-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
