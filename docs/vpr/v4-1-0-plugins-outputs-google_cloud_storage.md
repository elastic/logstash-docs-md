...
This plugin supports the following configuration options plus the [Common options](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`bucket`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-bucket "bucket") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`date_pattern`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-date_pattern "date_pattern") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`flush_interval_secs`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-flush_interval_secs "flush_interval_secs") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`gzip`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-gzip "gzip") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`gzip_content_encoding`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-gzip_content_encoding "gzip_content_encoding") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_hostname`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-include_hostname "include_hostname") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_uuid`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-include_uuid "include_uuid") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`json_key_file`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-json_key_file "json_key_file") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`key_password`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-key_password "key_password") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | *Deprecated* |
| [`key_path`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-key_path "key_path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | **Obsolete** |
| [`log_file_prefix`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-log_file_prefix "log_file_prefix") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`max_concurrent_uploads`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-max_concurrent_uploads "max_concurrent_uploads") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`max_file_size_kbytes`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-max_file_size_kbytes "max_file_size_kbytes") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`output_format`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-output_format "output_format") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["json", "plain", nil]` | *Deprecated* |
| [`service_account`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-service_account "service_account") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | *Deprecated* |
| [`temp_directory`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-temp_directory "temp_directory") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`uploader_interval_secs`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-uploader_interval_secs "uploader_interval_secs") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-common-options "Common options") for a list of options supported by all output plugins.
...
**Deprecated** this feature is no longer used, the setting is now a part of [`json_key_file`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-json_key_file "json_key_file").
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
