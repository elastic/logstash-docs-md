...
For other versions, see the [overview list](output-zabbix-index.md "Versioned zabbix output plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`multi_value`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-multi_value "multi_value") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`timeout`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-timeout "timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`zabbix_host`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-zabbix_host "zabbix_host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`zabbix_key`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-zabbix_key "zabbix_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`zabbix_server_host`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-zabbix_server_host "zabbix_server_host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`zabbix_server_port`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-zabbix_server_port "zabbix_server_port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`zabbix_value`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-zabbix_value "zabbix_value") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-3-plugins-outputs-zabbix.md#v3.0.3-plugins-outputs-zabbix-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
