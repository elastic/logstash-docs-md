...
| :- | :- | :- |
| [`format`](v3-0-5-plugins-codecs-msgpack.md#v3.0.5-plugins-codecs-msgpack-format "format") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
