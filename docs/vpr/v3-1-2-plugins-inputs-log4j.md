...
This plugin supports the following configuration options plus the [Common options](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`host`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`mode`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-mode "mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["server", "client"]` | No |
| [`port`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`proxy_protocol`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-proxy_protocol "proxy_protocol") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |

Also see [Common options](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v3-1-2-plugins-inputs-log4j.md#v3.1.2-plugins-inputs-log4j-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
