...
Next, [install filebeat](https://www.elastic.co/guide/en/beats/filebeat/7.8/filebeat-installation.html). Based on the above log4j.properties, we can use this filebeat configuration:
