...
This plugin supports the following configuration options plus the [Common options](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`access_key_id`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-access_key_id "access_key_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`aws_credentials_file`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-aws_credentials_file "aws_credentials_file") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`batch_events`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-batch_events "batch_events") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`endpoint`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-endpoint "endpoint") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`message_max_size`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-message_max_size "message_max_size") | [bytes](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#bytes) | No |
| [`proxy_uri`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-proxy_uri "proxy_uri") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`queue`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-queue "queue") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`region`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-region "region") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`role_arn`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-role_arn "role_arn") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`role_session_name`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-role_session_name "role_session_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`secret_access_key`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-secret_access_key "secret_access_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`session_token`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-session_token "session_token") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v6-0-0-plugins-outputs-sqs.md#v6.0.0-plugins-outputs-sqs-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
