...
| [`jdbc_password`](v5-1-1-plugins-inputs-jdbc.md#v5.1.1-plugins-inputs-jdbc-jdbc_password) | [password](logstash://reference/configuration-file-structure.md#password) | No |
