...
For other versions, see the [overview list](filter-dissect-index.md "Versioned dissect filter plugin docs").
...
#### Dissect or Grok? Or both? [_dissect_or_grok_or_both_3]
...
#### Sample configuration [_sample_configuration_14]
...
### Notations [_notations_3]

[Normal field notation](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-normal "Normal field notation")

[Skip field notation](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-skip "Skip field notation")

[Append field notation](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-append "Append field notation")

[Indirect field notation](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-indirect "Indirect field notation")

#### Notes and usage guidelines [_notes_and_usage_guidelines_3]
...
### Multiple Consecutive Delimiter Handling [_multiple_consecutive_delimiter_handling_3]
...
#### Empty data between delimiters [_empty_data_between_delimiters_3]
...
#### Delimiters used as padding to visually align fields [_delimiters_used_as_padding_to_visually_align_fields_3]
...
### Conditional processing [_conditional_processing_3]
...
This plugin supports the following configuration options plus the [Common options](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`convert_datatype`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-convert_datatype "convert_datatype") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`mapping`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-mapping "mapping") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`tag_on_failure`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-tag_on_failure "tag_on_failure") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |

Also see [Common options](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
