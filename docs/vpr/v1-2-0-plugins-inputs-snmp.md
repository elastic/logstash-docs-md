...
### Getting help [_getting_help_868]
...
This plugin supports the following configuration options plus the [Common options](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`get`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-get "get") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`hosts`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-hosts "hosts") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`interval`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-interval "interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`mib_paths`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-mib_paths "mib_paths") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`oid_root_skip`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-oid_root_skip "oid_root_skip") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`oid_path_length`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-oid_path_length "oid_path_length") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`walk`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-walk "walk") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`tables`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-tables "tables") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`auth_pass`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-auth_pass "auth_pass") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`auth_protocol`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-auth_protocol "auth_protocol") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["md5", "sha", "sha2", "hmac128sha224", "hmac192sha256", "hmac256sha384", "hmac384sha512"]` | No |
| [`priv_pass`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-priv_pass "priv_pass") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`priv_protocol`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-priv_protocol "priv_protocol") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["des", "3des", "aes", "aes128", "aes192", "aes256"]` | No |
| [`security_level`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-security_level "security_level") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["noAuthNoPriv", "authNoPriv", "authPriv"]` | No |
| [`security_name`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-security_name "security_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

### SNMP Input Configuration Options [_snmp_input_configuration_options_20]

Also see [Common options](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-common-options "Common options") for a list of options supported by all input plugins.
...
This plugin includes the IETF MIBs. If you require other MIBs, you need to import them. See [Importing MIBs](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-import-mibs "Importing MIBs").
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`enable_metric`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v1-2-0-plugins-inputs-snmp.md#v1.2.0-plugins-inputs-snmp-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
