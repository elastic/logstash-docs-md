...
This plugin supports the following configuration options plus the [Common options](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`consumer_key`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-consumer_key "consumer_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`consumer_secret`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-consumer_secret "consumer_secret") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | Yes |
| [`follows`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-follows "follows") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`full_tweet`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-full_tweet "full_tweet") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`ignore_retweets`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-ignore_retweets "ignore_retweets") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`keywords`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-keywords "keywords") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`languages`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-languages "languages") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`locations`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-locations "locations") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`oauth_token`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-oauth_token "oauth_token") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`oauth_token_secret`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-oauth_token_secret "oauth_token_secret") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | Yes |
| [`proxy_address`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-proxy_address "proxy_address") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`proxy_port`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-proxy_port "proxy_port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`rate_limit_reset_in`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-rate_limit_reset_in "rate_limit_reset_in") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`use_proxy`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-use_proxy "use_proxy") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`use_samples`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-use_samples "use_samples") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |

Also see [Common options](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v4-0-1-plugins-inputs-twitter.md#v4.0.1-plugins-inputs-twitter-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
