...
This plugin supports the following configuration options plus the [Common options](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`project_id`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-project_id "project_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`topic`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-topic "topic") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`json_key_file`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-json_key_file "json_key_file") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`delay_threshold_secs`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-delay_threshold_secs "delay_threshold_secs") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`message_count_threshold`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-message_count_threshold "message_count_threshold") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`request_byte_threshold`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-request_byte_threshold "request_byte_threshold") | [bytes](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#bytes) | No |
| [`attributes`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-attributes "attributes") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |

Also see [Common options](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v1-0-0-plugins-outputs-google_pubsub.md#v1.0.0-plugins-outputs-google_pubsub-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
