...
This plugin supports the following configuration options plus the [Common options](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`broker_url`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-broker_url "broker_url") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`destination`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-destination "destination") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`durable_subscriber`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-durable_subscriber "durable_subscriber") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`durable_subscriber_client_id`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-durable_subscriber_client_id "durable_subscriber_client_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`durable_subscriber_name`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-durable_subscriber_name "durable_subscriber_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`factory`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-factory "factory") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`factory_settings`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-factory_settings "factory_settings") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`include_body`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-include_body "include_body") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_header`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-include_header "include_header") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_properties`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-include_properties "include_properties") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`interval`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-interval "interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`jndi_context`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-jndi_context "jndi_context") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`jndi_name`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-jndi_name "jndi_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`keystore`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-keystore "keystore") | a valid filesystem path | No |
| [`keystore_password`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-keystore_password "keystore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`oracle_aq_buffered_messages`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-oracle_aq_buffered_messages "oracle_aq_buffered_messages") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`password`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-password "password") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`pub_sub`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-pub_sub "pub_sub") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`require_jars`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-require_jars "require_jars") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`runner`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-runner "runner") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | *Deprecated* |
| [`selector`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-selector "selector") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`skip_headers`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-skip_headers "skip_headers") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`skip_properties`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-skip_properties "skip_properties") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`system_properties`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-system_properties "system_properties") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`threads`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-threads "threads") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`timeout`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-timeout "timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`truststore`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-truststore "truststore") | a valid filesystem path | No |
| [`truststore_password`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-truststore_password "truststore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`use_jms_timestamp`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-use_jms_timestamp "use_jms_timestamp") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`username`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-username "username") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`yaml_file`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-yaml_file "yaml_file") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`yaml_section`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-yaml_section "yaml_section") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v3-1-2-plugins-inputs-jms.md#v3.1.2-plugins-inputs-jms-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
