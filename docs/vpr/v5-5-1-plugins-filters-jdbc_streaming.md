...
This plugin supports the following configuration options plus the [Common options](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`cache_expiration`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-cache_expiration "cache_expiration") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`cache_size`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-cache_size "cache_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`default_hash`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-default_hash "default_hash") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`jdbc_connection_string`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-jdbc_connection_string "jdbc_connection_string") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`jdbc_driver_class`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-jdbc_driver_class "jdbc_driver_class") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`jdbc_driver_library`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-jdbc_driver_library "jdbc_driver_library") | a valid filesystem path | No |
| [`jdbc_password`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-jdbc_password "jdbc_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`jdbc_user`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-jdbc_user "jdbc_user") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`jdbc_validate_connection`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-jdbc_validate_connection "jdbc_validate_connection") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`jdbc_validation_timeout`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-jdbc_validation_timeout "jdbc_validation_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`parameters`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-parameters "parameters") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`prepared_statement_bind_values`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-prepared_statement_bind_values "prepared_statement_bind_values") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`prepared_statement_name`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-prepared_statement_name "prepared_statement_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`prepared_statement_warn_on_constant_usage`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-prepared_statement_warn_on_constant_usage "prepared_statement_warn_on_constant_usage") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`sequel_opts`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-sequel_opts "sequel_opts") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`statement`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-statement "statement") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`tag_on_default_use`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-tag_on_default_use "tag_on_default_use") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`tag_on_failure`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-tag_on_failure "tag_on_failure") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`target`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`use_cache`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-use_cache "use_cache") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`use_prepared_statements`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-use_prepared_statements "use_prepared_statements") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |

Also see [Common options](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-common-options "Common options") for a list of options supported by all filter plugins.
...
Array of bind values for the prepared statement. Use field references and constants. See the section on [prepared\_statements](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-prepared_statements "Prepared Statements") for more info.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v5-5-1-plugins-filters-jdbc_streaming.md#v5.5.1-plugins-filters-jdbc_streaming-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
