...
| [`reconnect_backoff_ms`](v11-0-0-plugins-outputs-kafka.md#v11.0.0-plugins-outputs-kafka-reconnect_backoff_ms) | [number](logstash://reference/configuration-file-structure.md#number) | No |
