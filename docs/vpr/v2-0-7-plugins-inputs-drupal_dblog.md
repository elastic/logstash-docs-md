...
For other versions, see the [overview list](input-drupal_dblog-index.md "Versioned drupal_dblog input plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_usernames`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-add_usernames "add_usernames") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`bulksize`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-bulksize "bulksize") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`databases`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-databases "databases") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`interval`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-interval "interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v2-0-7-plugins-inputs-drupal_dblog.md#v2.0.7-plugins-inputs-drupal_dblog-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
