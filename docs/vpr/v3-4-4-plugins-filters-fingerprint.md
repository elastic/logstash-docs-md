...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)][Elastic Common Schema (ECS)\]\(([^:]+)://reference/index.md)). See [Event Metadata and the Elastic Common Schema (ECS)](v3-4-4-plugins-filters-fingerprint.md#v3.4.4-plugins-filters-fingerprint-ecs_metadata) for detailed information.
