...
| [`pipeline`](v9-0-0-plugins-outputs-elasticsearch.md#v9.0.0-plugins-outputs-elasticsearch-pipeline) | [string](logstash://reference/configuration-file-structure.md#string) | No |
