...
This plugin supports the following configuration options plus the [Common options](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`overwrite`](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-overwrite "overwrite") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`target`](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |

Also see [Common options](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-0-5-plugins-filters-uuid.md#v3.0.5-plugins-filters-uuid-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
