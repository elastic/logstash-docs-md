...
| :- | :- | :- |
| [`compress_level`](v2-0-5-plugins-codecs-compress_spooler.md#v2.0.5-plugins-codecs-compress_spooler-compress_level "compress_level") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`min_flush_time`](v2-0-5-plugins-codecs-compress_spooler.md#v2.0.5-plugins-codecs-compress_spooler-min_flush_time "min_flush_time") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`spool_size`](v2-0-5-plugins-codecs-compress_spooler.md#v2.0.5-plugins-codecs-compress_spooler-spool_size "spool_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
