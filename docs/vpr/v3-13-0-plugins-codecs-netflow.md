...
| :- | :- | :- |
| [`cache_save_path`](v3-13-0-plugins-codecs-netflow.md#v3.13.0-plugins-codecs-netflow-cache_save_path "cache_save_path") | a valid filesystem path | No |
| [`cache_ttl`](v3-13-0-plugins-codecs-netflow.md#v3.13.0-plugins-codecs-netflow-cache_ttl "cache_ttl") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`include_flowset_id`](v3-13-0-plugins-codecs-netflow.md#v3.13.0-plugins-codecs-netflow-include_flowset_id "include_flowset_id") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`ipfix_definitions`](v3-13-0-plugins-codecs-netflow.md#v3.13.0-plugins-codecs-netflow-ipfix_definitions "ipfix_definitions") | a valid filesystem path | No |
| [`netflow_definitions`](v3-13-0-plugins-codecs-netflow.md#v3.13.0-plugins-codecs-netflow-netflow_definitions "netflow_definitions") | a valid filesystem path | No |
| [`target`](v3-13-0-plugins-codecs-netflow.md#v3.13.0-plugins-codecs-netflow-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`versions`](v3-13-0-plugins-codecs-netflow.md#v3.13.0-plugins-codecs-netflow-versions "versions") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
