...
| :- | :- | :- |
| [`delimiter`](v6-1-1-plugins-codecs-cef.md#v6.1.1-plugins-codecs-cef-delimiter "delimiter") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`fields`](v6-1-1-plugins-codecs-cef.md#v6.1.1-plugins-codecs-cef-fields "fields") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`name`](v6-1-1-plugins-codecs-cef.md#v6.1.1-plugins-codecs-cef-name "name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`product`](v6-1-1-plugins-codecs-cef.md#v6.1.1-plugins-codecs-cef-product "product") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`reverse_mapping`](v6-1-1-plugins-codecs-cef.md#v6.1.1-plugins-codecs-cef-reverse_mapping "reverse_mapping") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`severity`](v6-1-1-plugins-codecs-cef.md#v6.1.1-plugins-codecs-cef-severity "severity") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`signature`](v6-1-1-plugins-codecs-cef.md#v6.1.1-plugins-codecs-cef-signature "signature") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`vendor`](v6-1-1-plugins-codecs-cef.md#v6.1.1-plugins-codecs-cef-vendor "vendor") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`version`](v6-1-1-plugins-codecs-cef.md#v6.1.1-plugins-codecs-cef-version "version") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
