...
This plugin supports the following configuration options plus the [Common options](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`field`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-field "field") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`target`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`terminator`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-terminator "terminator") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-1-5-plugins-filters-split.md#v3.1.5-plugins-filters-split-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
