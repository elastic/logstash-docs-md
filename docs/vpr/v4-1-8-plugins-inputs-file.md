...
In some cases it is useful to be able to control which files are read first, sorting, and whether files are read completely or banded/striped. Complete reading is **all of** file A then file B then file C and so on. Banded or striped reading is **some of** file A then file B then file C and so on looping around to file A again until all files are read. Banded reading is specified by changing [`file_chunk_count`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-file_chunk_count "file_chunk_count") and perhaps [`file_chunk_size`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-file_chunk_size "file_chunk_size"). Banding and sorting may be useful if you want some events from all files to appear in Kibana as early as possible.
...
This plugin supports the following configuration options plus the [Common options](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-common-options "Common options") described later.

Duration settings can be specified in text form e.g. "250 ms", this string will be converted into decimal seconds. There are quite a few supported natural and abbreviated durations, see [string\_duration](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-string_duration "String Durations") for the details.

| Setting | Input type | Required |
| :- | :- | :- |
| [`close_older`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-close_older "close_older") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) or [string\_duration](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-string_duration "String Durations") | No |
| [`delimiter`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-delimiter "delimiter") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`discover_interval`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-discover_interval "discover_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`exclude`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-exclude "exclude") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`file_chunk_count`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-file_chunk_count "file_chunk_count") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`file_chunk_size`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-file_chunk_size "file_chunk_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`file_completed_action`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-file_completed_action "file_completed_action") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["delete", "log", "log_and_delete"]` | No |
| [`file_completed_log_path`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-file_completed_log_path "file_completed_log_path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`file_sort_by`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-file_sort_by "file_sort_by") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["last_modified", "path"]` | No |
| [`file_sort_direction`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-file_sort_direction "file_sort_direction") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["asc", "desc"]` | No |
| [`ignore_older`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-ignore_older "ignore_older") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) or [string\_duration](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-string_duration "String Durations") | No |
| [`max_open_files`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-max_open_files "max_open_files") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`mode`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-mode "mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["tail", "read"]` | No |
| [`path`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-path "path") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes |
| [`sincedb_clean_after`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-sincedb_clean_after "sincedb_clean_after") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) or [string\_duration](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-string_duration "String Durations") | No |
| [`sincedb_path`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-sincedb_path "sincedb_path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`sincedb_write_interval`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-sincedb_write_interval "sincedb_write_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) or [string\_duration](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-string_duration "String Durations") | No |
| [`start_position`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-start_position "start_position") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["beginning", "end"]` | No |
| [`stat_interval`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-stat_interval "stat_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) or [string\_duration](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-string_duration "String Durations") | No |

Also see [Common options](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-common-options "Common options") for a list of options supported by all input plugins.

 

#### `close_older` [v4.1.8-plugins-inputs-file-close_older]

* Value type is [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) or [string\_duration](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-string_duration "String Durations")
...
File content is read off disk in blocks or chunks and lines are extracted from the chunk. See [`file_chunk_count`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-file_chunk_count "file_chunk_count") to see why and when to change this setting from the default.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v4-1-8-plugins-inputs-file.md#v4.1.8-plugins-inputs-file-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
