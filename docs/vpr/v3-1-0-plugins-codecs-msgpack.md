...
For other versions, see the [overview list](codec-msgpack-index.md "Versioned msgpack codec plugin docs").
...
| :- | :- | :- |
| [`format`](v3-1-0-plugins-codecs-msgpack.md#v3.1.0-plugins-codecs-msgpack-format "format") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`target`](v3-1-0-plugins-codecs-msgpack.md#v3.1.0-plugins-codecs-msgpack-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
