...
| --- | --- | --- |
| [`cache_size`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-cache_size) | [number](logstash://reference/configuration-file-structure.md#number) | No |
...
| [`ecs_compatibility`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-ecs_compatibility) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`fields`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-fields) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`source`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-source) | [string](logstash://reference/configuration-file-structure.md#string) | Yes |
| [`tag_on_failure`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-tag_on_failure) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`target`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-target) | [string](logstash://reference/configuration-file-structure.md#string) | No |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)][Elastic Common Schema (ECS)\]\(([^:]+)://reference/index.md)). The value of this setting affects the *default* value of [`target`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-target).
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`add_tag`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-add_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`enable_metric`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`periodic_flush`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-periodic_flush) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`remove_field`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-remove_field) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`remove_tag`](v7-2-11-plugins-filters-geoip.md#v7.2.11-plugins-filters-geoip-remove_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
