...
### Getting help [_getting_help_2095]
...
This plugin supports the following configuration options plus the [Common options](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`allow_duplicate_values`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-allow_duplicate_values "allow_duplicate_values") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`default_keys`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-default_keys "default_keys") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`exclude_keys`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-exclude_keys "exclude_keys") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`field_split`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-field_split "field_split") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`include_brackets`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-include_brackets "include_brackets") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_keys`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-include_keys "include_keys") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`prefix`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-prefix "prefix") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`recursive`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-recursive "recursive") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_char_key`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-remove_char_key "remove_char_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`remove_char_value`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-remove_char_value "remove_char_value") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`source`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-source "source") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`target`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`transform_key`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-transform_key "transform_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["lowercase", "uppercase", "capitalize"]` | No |
| [`transform_value`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-transform_value "transform_value") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["lowercase", "uppercase", "capitalize"]` | No |
| [`trim_key`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-trim_key "trim_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`trim_value`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-trim_value "trim_value") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`value_split`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-value_split "value_split") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v4-0-2-plugins-filters-kv.md#v4.0.2-plugins-filters-kv-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
