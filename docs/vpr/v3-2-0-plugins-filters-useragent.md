...
This plugin supports the following configuration options plus the [Common options](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`lru_cache_size`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-lru_cache_size "lru_cache_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`prefix`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-prefix "prefix") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`regexes`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-regexes "regexes") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`source`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-source "source") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`target`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-2-0-plugins-filters-useragent.md#v3.2.0-plugins-filters-useragent-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
