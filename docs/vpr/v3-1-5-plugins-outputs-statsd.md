...
For other versions, see the [overview list](output-statsd-index.md "Versioned statsd output plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`count`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-count "count") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`decrement`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-decrement "decrement") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`gauge`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-gauge "gauge") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`host`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`increment`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-increment "increment") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`namespace`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-namespace "namespace") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`port`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`sample_rate`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-sample_rate "sample_rate") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`sender`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-sender "sender") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`set`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-set "set") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`timing`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-timing "timing") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |

Also see [Common options](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-5-plugins-outputs-statsd.md#v3.1.5-plugins-outputs-statsd-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
