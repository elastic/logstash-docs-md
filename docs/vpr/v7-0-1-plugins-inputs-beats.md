...
When decoding Beats events, this plugin enriches each event with metadata about the event’s source, making this information available during further processing. You can use the [`enrich`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-enrich "enrich") option to activate or deactivate individual enrichment categories.

The location of these enrichment fields depends on whether [ECS compatibility mode](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ecs_compatibility "ecs_compatibility") is enabled:
...
This plugin supports the following configuration options plus the [Common options](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-common-options "Common options") described later.

As of version `7.0.0` of this plugin, a number of previously deprecated settings related to SSL have been removed. Please check out [Beats Input Obsolete Configuration Options](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-obsolete-options "Beats Input Obsolete Configuration Options") for details.

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_hostname`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-add_hostname "add_hostname") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | *Deprecated* |
| [`client_inactivity_timeout`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-client_inactivity_timeout "client_inactivity_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`ecs_compatibility`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`enrich`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-enrich "enrich") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`event_loop_threads`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-event_loop_threads "event_loop_threads") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`executor_threads`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-executor_threads "executor_threads") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`host`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`include_codec_tag`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-include_codec_tag "include_codec_tag") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | *Deprecated* |
| [`port`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | Yes |
| [`ssl_certificate`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_certificate "ssl_certificate") | a valid filesystem path | No |
| [`ssl_certificate_authorities`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_certificate_authorities "ssl_certificate_authorities") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl_cipher_suites`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_cipher_suites "ssl_cipher_suites") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl_client_authentication`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_client_authentication "ssl_client_authentication") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["none", "optional", "required"]` | No |
| [`ssl_enabled`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_enabled "ssl_enabled") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`ssl_handshake_timeout`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_handshake_timeout "ssl_handshake_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`ssl_key`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_key "ssl_key") | a valid filesystem path | No |
| [`ssl_key_passphrase`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_key_passphrase "ssl_key_passphrase") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`ssl_supported_protocols`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_supported_protocols "ssl_supported_protocols") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |

Also see [Common options](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-common-options "Common options") for a list of options supported by all input plugins.
...
Refer to [ECS mapping](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ecs_metadata "Event enrichment and the Elastic Common Schema (ECS)") for detailed information.
...
Replaced by [`enrich`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-enrich "enrich")
...
When mutual TLS is enabled (`required` or `optional`), the certificate presented by the client must be signed by trusted [`ssl_certificate_authorities`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_certificate_authorities "ssl_certificate_authorities") (CAs). Please note that the server does not validate the client certificate CN (Common Name) or SAN (Subject Alternative Name).

This setting can be used only if [`ssl_certificate_authorities`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_certificate_authorities "ssl_certificate_authorities") is set.
...
Events are by default sent in plain text. You can enable encryption by setting `ssl_enabled` to true and configuring the [`ssl_certificate`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_certificate "ssl_certificate") and [`ssl_key`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_key "ssl_key") options.
...
| Setting | Replaced by |
| :- | :- |
| cipher\_suites | [`ssl_cipher_suites`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_cipher_suites "ssl_cipher_suites") |
| ssl | [`ssl_enabled`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_enabled "ssl_enabled") |
| ssl\_peer\_metadata | [`enrich`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-enrich "enrich") |
| ssl\_verify\_mode | [`ssl_client_authentication`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_client_authentication "ssl_client_authentication") |
| tls\_max\_version | [`ssl_supported_protocols`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_supported_protocols "ssl_supported_protocols") |
| tls\_min\_version | [`ssl_supported_protocols`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-ssl_supported_protocols "ssl_supported_protocols") |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
...
The Beats shipper automatically sets the `type` field on the event. You cannot override this setting in the Logstash config. If you specify a setting for the [`type`](v7-0-1-plugins-inputs-beats.md#v7.0.1-plugins-inputs-beats-type "type") config option in Logstash, it is ignored.
