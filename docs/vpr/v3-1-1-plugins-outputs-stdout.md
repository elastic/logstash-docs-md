...
There are no special configuration options for this plugin, but it does support the [Common options](v3-1-1-plugins-outputs-stdout.md#v3.1.1-plugins-outputs-stdout-common-options "Common options").
...
| :- | :- | :- |
| [`codec`](v3-1-1-plugins-outputs-stdout.md#v3.1.1-plugins-outputs-stdout-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-1-1-plugins-outputs-stdout.md#v3.1.1-plugins-outputs-stdout-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-1-plugins-outputs-stdout.md#v3.1.1-plugins-outputs-stdout-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
