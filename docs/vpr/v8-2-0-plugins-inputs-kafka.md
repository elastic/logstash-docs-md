...
| [`heartbeat_interval_ms`](v8-2-0-plugins-inputs-kafka.md#v8.2.0-plugins-inputs-kafka-heartbeat_interval_ms) | [string](logstash://reference/configuration-file-structure.md#string) | No |
