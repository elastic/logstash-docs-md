...
This plugin supports the following configuration options plus the [Common options](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`access_key_id`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-access_key_id "access_key_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`arn`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-arn "arn") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`aws_credentials_file`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-aws_credentials_file "aws_credentials_file") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`proxy_uri`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-proxy_uri "proxy_uri") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`publish_boot_message_arn`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-publish_boot_message_arn "publish_boot_message_arn") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`region`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-region "region") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["us-east-1", "us-east-2", "us-west-1", "us-west-2", "eu-central-1", "eu-west-1", "eu-west-2", "ap-southeast-1", "ap-southeast-2", "ap-northeast-1", "ap-northeast-2", "sa-east-1", "us-gov-west-1", "cn-north-1", "ap-south-1", "ca-central-1"]` | No |
| [`secret_access_key`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-secret_access_key "secret_access_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`session_token`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-session_token "session_token") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v7-1-1-plugins-outputs-sns.md#v7.1.1-plugins-outputs-sns-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
