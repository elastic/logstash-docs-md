...
This plugin supports the following configuration options plus the [Common options](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`flush_size`](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-flush_size "flush_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`hosts`](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-hosts "hosts") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes |
| [`idle_flush_time`](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-idle_flush_time "idle_flush_time") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`port`](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | Yes |
| [`ssl_certificate`](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-ssl_certificate "ssl_certificate") | a valid filesystem path | Yes |

Also see [Common options](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-3-plugins-outputs-lumberjack.md#v3.1.3-plugins-outputs-lumberjack-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
