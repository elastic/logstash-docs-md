...
This plugin supports the following configuration options plus the [Common options](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`ecs_compatibility`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`facility_labels`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-facility_labels "facility_labels") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`grok_pattern`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-grok_pattern "grok_pattern") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`host`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`locale`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-locale "locale") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`port`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`proxy_protocol`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-proxy_protocol "proxy_protocol") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`severity_labels`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-severity_labels "severity_labels") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`syslog_field`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-syslog_field "syslog_field") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`timezone`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-timezone "timezone") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`use_labels`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-use_labels "use_labels") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |

Also see [Common options](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-common-options "Common options") for a list of options supported by all input plugins.
...
* Default value depends on whether [`ecs_compatibility`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-ecs_compatibility "ecs_compatibility") is enabled:
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v3-7-0-plugins-inputs-syslog.md#v3.7.0-plugins-inputs-syslog-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
