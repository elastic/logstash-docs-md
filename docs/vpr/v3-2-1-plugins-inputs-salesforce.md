...
This plugin supports the following configuration options plus the [Common options](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`api_version`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-api_version "api_version") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`client_id`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-client_id "client_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`client_secret`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-client_secret "client_secret") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | Yes |
| [`password`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-password "password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | Yes |
| [`security_token`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-security_token "security_token") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | Yes |
| [`sfdc_fields`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-sfdc_fields "sfdc_fields") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`sfdc_filters`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-sfdc_filters "sfdc_filters") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`sfdc_instance_url`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-sfdc_instance_url "sfdc_instance_url") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`sfdc_object_name`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-sfdc_object_name "sfdc_object_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`to_underscores`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-to_underscores "to_underscores") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`use_test_sandbox`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-use_test_sandbox "use_test_sandbox") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`use_tooling_api`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-use_tooling_api "use_tooling_api") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`username`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-username "username") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |

Also see [Common options](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v3-2-1-plugins-inputs-salesforce.md#v3.2.1-plugins-inputs-salesforce-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
