...
| [`verify_cert`](v3-0-6-plugins-inputs-imap.md#v3.0.6-plugins-inputs-imap-verify_cert) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
