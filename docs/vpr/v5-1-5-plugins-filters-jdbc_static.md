...
* **lookups**
  ...
  | [**](#) | Defines the columns, types, and indexes used to build the local database structure. The column names and types should match the external database. The order of table definitions is significant and should match that of the loader queries. See [Loader column and local\_db\_object order dependency](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-object_order "Loader column and local_db_object order dependency"). |
...
### Using this plugin with multiple pipelines [_using_this_plugin_with_multiple_pipelines_29]
...
This plugin supports the following configuration options plus the [Common options](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`jdbc_connection_string`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-jdbc_connection_string "jdbc_connection_string") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`jdbc_driver_class`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-jdbc_driver_class "jdbc_driver_class") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`jdbc_driver_library`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-jdbc_driver_library "jdbc_driver_library") | a valid filesystem path | No |
| [`jdbc_password`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-jdbc_password "jdbc_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`jdbc_user`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-jdbc_user "jdbc_user") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tag_on_failure`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-tag_on_failure "tag_on_failure") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`tag_on_default_use`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-tag_on_default_use "tag_on_default_use") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`staging_directory`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-staging_directory "staging_directory") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`loader_schedule`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-loader_schedule "loader_schedule") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`loaders`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-loaders "loaders") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`local_db_objects`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-local_db_objects "local_db_objects") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`local_lookups`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-local_lookups "local_lookups") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |

Also see [Common options](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v5-1-5-plugins-filters-jdbc_static.md#v5.1.5-plugins-filters-jdbc_static-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
