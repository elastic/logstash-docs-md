...
* Elasticsearch Serverless uses **data streams** and [data lifecycle management (DLM)](docs-content://manage-data/lifecycle/data-stream.md) instead of index lifecycle management (ILM). Any ILM settings in your [Elasticsearch output plugin](v11-22-7-plugins-outputs-elasticsearch.md) configuration are ignored and may cause errors.
