...
| [`uid_tracking`](v3-0-7-plugins-inputs-imap.md#v3.0.7-plugins-inputs-imap-uid_tracking) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
