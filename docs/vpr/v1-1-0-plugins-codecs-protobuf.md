...
| :- | :- | :- |
| [`class_name`](v1-1-0-plugins-codecs-protobuf.md#v1.1.0-plugins-codecs-protobuf-class_name "class_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`include_path`](v1-1-0-plugins-codecs-protobuf.md#v1.1.0-plugins-codecs-protobuf-include_path "include_path") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes |
