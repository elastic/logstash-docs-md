...
| [`timestamp_field`](v3-1-3-plugins-outputs-graphite.md#v3.1.3-plugins-outputs-graphite-timestamp_field) | [string](logstash://reference/configuration-file-structure.md#string) | No |
