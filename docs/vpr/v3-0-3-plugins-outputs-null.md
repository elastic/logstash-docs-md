...
For other versions, see the [overview list](output-null-index.md "Versioned null output plugin docs").
...
There are no special configuration options for this plugin, but it does support the [Common options](v3-0-3-plugins-outputs-null.md#v3.0.3-plugins-outputs-null-common-options "Common options").
...
| :- | :- | :- |
| [`codec`](v3-0-3-plugins-outputs-null.md#v3.0.3-plugins-outputs-null-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-3-plugins-outputs-null.md#v3.0.3-plugins-outputs-null-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-3-plugins-outputs-null.md#v3.0.3-plugins-outputs-null-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
