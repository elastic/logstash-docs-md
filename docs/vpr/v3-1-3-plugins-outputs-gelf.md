...
This plugin supports the following configuration options plus the [Common options](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`chunksize`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-chunksize "chunksize") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`custom_fields`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-custom_fields "custom_fields") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`full_message`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-full_message "full_message") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`host`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`ignore_metadata`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-ignore_metadata "ignore_metadata") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`level`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-level "level") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`port`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`sender`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-sender "sender") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`ship_metadata`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-ship_metadata "ship_metadata") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`ship_tags`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-ship_tags "ship_tags") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`short_message`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-short_message "short_message") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-3-plugins-outputs-gelf.md#v3.1.3-plugins-outputs-gelf-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
