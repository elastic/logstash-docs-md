...
This plugin supports the following configuration options plus the [Common options](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`convert`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-convert "convert") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`copy`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-copy "copy") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`gsub`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-gsub "gsub") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`join`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-join "join") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`lowercase`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-lowercase "lowercase") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`merge`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-merge "merge") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`coerce`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-coerce "coerce") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`rename`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-rename "rename") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`replace`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-replace "replace") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`split`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-split "split") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`strip`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-strip "strip") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`update`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-update "update") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`uppercase`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-uppercase "uppercase") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`capitalize`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-capitalize "capitalize") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |

Also see [Common options](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-3-4-plugins-filters-mutate.md#v3.3.4-plugins-filters-mutate-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
