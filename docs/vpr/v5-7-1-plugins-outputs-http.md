...
| [`request_timeout`](v5-7-1-plugins-outputs-http.md#v5.7.1-plugins-outputs-http-request_timeout) | [number](logstash://reference/configuration-file-structure.md#number) | No |
