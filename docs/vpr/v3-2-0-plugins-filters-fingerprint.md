...
This plugin supports the following configuration options plus the [Common options](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`base64encode`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-base64encode "base64encode") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`concatenate_sources`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-concatenate_sources "concatenate_sources") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`concatenate_all_fields`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-concatenate_all_fields "concatenate_all_fields") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`key`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-key "key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`method`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-method "method") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["SHA1", "SHA256", "SHA384", "SHA512", "MD5", "MURMUR3", "IPV4_NETWORK", "UUID", "PUNCTUATION"]` | Yes |
| [`source`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-source "source") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`target`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-2-0-plugins-filters-fingerprint.md#v3.2.0-plugins-filters-fingerprint-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
