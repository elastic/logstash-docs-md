...
### Getting help [_getting_help_2260]
...
### Compatibility with the Elastic Common Schema (ECS) [_compatibility_with_the_elastic_common_schema_ecs_95]
...
The ECS Compatibility mode for a specific plugin instance can be controlled by setting [`ecs_compatibility`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-ecs_compatibility "ecs_compatibility") when defining the codec:
...
* When the timestamp does not include UTC-offset information, we use the event’s timezone (`dtz` or `deviceTimeZone` field), or fall through to this plugin’s [`default_timezone`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-default_timezone "default_timezone").
* Localized timestamps are parsed using the provided [`locale`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-locale "locale").

### Cef Codec Configuration Options [v6.2.0-plugins-codecs-cef-options]

| Setting | Input type | Required |
| :- | :- | :- |
| [`default_timezone`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-default_timezone "default_timezone") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`delimiter`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-delimiter "delimiter") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`device`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-device "device") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`ecs_compatibility`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`fields`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-fields "fields") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`locale`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-locale "locale") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`name`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-name "name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`product`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-product "product") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`reverse_mapping`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-reverse_mapping "reverse_mapping") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`severity`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-severity "severity") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`signature`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-signature "signature") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`vendor`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-vendor "vendor") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`version`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-version "version") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
...
* Option has no effect when [`ecs_compatibility => disabled`](v6-2-0-plugins-codecs-cef.md#v6.2.0-plugins-codecs-cef-ecs_compatibility "ecs_compatibility").
