...
This plugin supports the following configuration options plus the [Common options](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`after_count`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-after_count "after_count") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`before_count`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-before_count "before_count") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`key`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-key "key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`max_age`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-max_age "max_age") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`max_counters`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-max_counters "max_counters") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`period`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-period "period") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v4-0-3-plugins-filters-throttle.md#v4.0.3-plugins-filters-throttle-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
