...
For other versions, see the [overview list](codec-rubydebug-index.md "Versioned rubydebug codec plugin docs").
...
| :- | :- | :- |
| [`metadata`](v3-0-3-plugins-codecs-rubydebug.md#v3.0.3-plugins-codecs-rubydebug-metadata "metadata") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
