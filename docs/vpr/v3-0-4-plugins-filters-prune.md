...
For other versions, see the [overview list](filter-prune-index.md "Versioned prune filter plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`blacklist_names`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-blacklist_names "blacklist_names") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`blacklist_values`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-blacklist_values "blacklist_values") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`interpolate`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-interpolate "interpolate") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`whitelist_names`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-whitelist_names "whitelist_names") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`whitelist_values`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-whitelist_values "whitelist_values") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |

Also see [Common options](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-0-4-plugins-filters-prune.md#v3.0.4-plugins-filters-prune-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
