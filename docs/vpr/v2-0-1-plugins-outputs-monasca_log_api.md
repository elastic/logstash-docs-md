...
| [`project_name`](v2-0-1-plugins-outputs-monasca_log_api.md#v2.0.1-plugins-outputs-monasca_log_api-project_name) | [string](logstash://reference/configuration-file-structure.md#string) | Yes |
