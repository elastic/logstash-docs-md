...
This plugin adds metadata about the event’s source, and can be configured to do so in an [ECS-compatible](https://www.elastic.co/guide/en/ecs/current) way with [`ecs_compatibility`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-ecs_compatibility "ecs_compatibility"). This metadata is added after the event has been decoded by the appropriate codec, and will not overwrite existing values.
...
This plugin supports the following configuration options plus the [Common options](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`command`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-command "command") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`ecs_compatibility`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`interval`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-interval "interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`schedule`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-schedule "schedule") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-common-options "Common options") for a list of options supported by all input plugins.
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). See [Compatibility with the Elastic Common Schema (ECS)](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-ecs "Compatibility with the Elastic Common Schema (ECS)") for detailed information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
