...
| [`timestamp_field`](v3-1-2-plugins-outputs-graphite.md#v3.1.2-plugins-outputs-graphite-timestamp_field) | [string](logstash://reference/configuration-file-structure.md#string) | No |
