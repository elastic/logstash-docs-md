...
For other versions, see the [overview list](input-zeromq-index.md "Versioned zeromq input plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`address`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-address "address") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`mode`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-mode "mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["server", "client"]` | No |
| [`sender`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-sender "sender") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`sockopt`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-sockopt "sockopt") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`topic`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-topic "topic") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`topic_field`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-topic_field "topic_field") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`topology`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-topology "topology") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["pushpull", "pubsub", "pair"]` | Yes |

Also see [Common options](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v3-0-5-plugins-inputs-zeromq.md#v3.0.5-plugins-inputs-zeromq-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
