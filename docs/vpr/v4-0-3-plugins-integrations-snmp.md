...
For other versions, see the [overview list](integration-snmp-index.md "Versioned snmp integration plugin docs").
...
Be aware of [behavioral and mapping differences](v4-0-3-plugins-integrations-snmp.md#v4.0.3-plugins-integrations-snmp-migration "Migrating to logstash-integration-snmp from individual plugins") between current stand-alone plugins and the new versions included in the `integration-snmp`. The information in this topic can help.
...
* [Migrating to `logstash-integration-snmp` from individual plugins](v4-0-3-plugins-integrations-snmp.md#v4.0.3-plugins-integrations-snmp-migration "Migrating to logstash-integration-snmp from individual plugins")
* [Importing MIBs](v4-0-3-plugins-integrations-snmp.md#v4.0.3-plugins-integrations-snmp-import-mibs "Importing MIBs")
