...
| :- | :- | :- |
| [`schema_uri`](v3-2-2-plugins-codecs-avro.md#v3.2.2-plugins-codecs-avro-schema_uri "schema_uri") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`tag_on_failure`](v3-2-2-plugins-codecs-avro.md#v3.2.2-plugins-codecs-avro-tag_on_failure "tag_on_failure") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
