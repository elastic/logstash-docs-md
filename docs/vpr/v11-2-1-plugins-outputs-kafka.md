...
| [`reconnect_backoff_ms`](v11-2-1-plugins-outputs-kafka.md#v11.2.1-plugins-outputs-kafka-reconnect_backoff_ms) | [number](logstash://reference/configuration-file-structure.md#number) | No |
