...
This plugin supports the following configuration options plus the [Common options](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`batch`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-batch "batch") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`batch_events`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-batch_events "batch_events") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`batch_timeout`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-batch_timeout "batch_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`congestion_interval`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-congestion_interval "congestion_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`congestion_threshold`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-congestion_threshold "congestion_threshold") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`data_type`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-data_type "data_type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["list", "channel"]` | No |
| [`db`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-db "db") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`host`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-host "host") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`key`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-key "key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`password`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-password "password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`port`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`reconnect_interval`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-reconnect_interval "reconnect_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`shuffle_hosts`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-shuffle_hosts "shuffle_hosts") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`timeout`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-timeout "timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-0-plugins-outputs-redis.md#v4.0.0-plugins-outputs-redis-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
