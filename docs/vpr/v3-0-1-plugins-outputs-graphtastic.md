...
This plugin supports the following configuration options plus the [Common options](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`batch_number`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-batch_number "batch_number") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`context`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-context "context") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`error_file`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-error_file "error_file") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`host`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`integration`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-integration "integration") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["udp", "tcp", "rmi", "rest"]` | No |
| [`metrics`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-metrics "metrics") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`port`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`retries`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-retries "retries") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-1-plugins-outputs-graphtastic.md#v3.0.1-plugins-outputs-graphtastic-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
