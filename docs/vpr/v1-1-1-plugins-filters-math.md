...
This plugin supports the following configuration options plus the [Common options](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`calculate`](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-calculate "calculate") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) of [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes |

Also see [Common options](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
