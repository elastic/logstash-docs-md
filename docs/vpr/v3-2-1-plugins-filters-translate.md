...
This plugin supports the following configuration options plus the [Common options](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`destination`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-destination "destination") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`dictionary`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-dictionary "dictionary") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`dictionary_path`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-dictionary_path "dictionary_path") | a valid filesystem path | No |
| [`exact`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-exact "exact") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`fallback`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-fallback "fallback") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`field`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-field "field") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`iterate_on`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-iterate_on "iterate_on") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`override`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-override "override") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`refresh_interval`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-refresh_interval "refresh_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`regex`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-regex "regex") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`refresh_behaviour`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-refresh_behaviour "refresh_behaviour") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
