...
| [`session_token`](v4-2-0-plugins-outputs-s3.md#v4.2.0-plugins-outputs-s3-session_token) | [string](logstash://reference/configuration-file-structure.md#string) | No |
