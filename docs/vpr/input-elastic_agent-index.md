...
The `input-elastic_agent` plugin is the next generation of the [input-beats plugin](input-beats-index.md "Versioned beats input plugin docs"), and is based on the [same github repository](https://github.com/logstash-plugins/logstash-input-beats).
