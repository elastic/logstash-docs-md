...
For other versions, see the [overview list](input-neo4j-index.md "Versioned neo4j input plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`path`](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-path "path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`query`](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-query "query") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`schedule`](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-schedule "schedule") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v2-0-6-plugins-inputs-neo4j.md#v2.0.6-plugins-inputs-neo4j-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
