...
| [`retry_on_conflict`](v8-0-0-plugins-outputs-elasticsearch.md#v8.0.0-plugins-outputs-elasticsearch-retry_on_conflict) | [number](logstash://reference/configuration-file-structure.md#number) | No |
