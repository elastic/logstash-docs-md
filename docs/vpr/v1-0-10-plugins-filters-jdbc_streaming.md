...
Array of bind values for the prepared statement. Use field references and constants. See the section on [prepared\_statements](v1-0-10-plugins-filters-jdbc_streaming.md#v1.0.10-plugins-filters-jdbc_streaming-prepared_statements) for more info.
