...
For other versions, see the [overview list](input-kinesis-index.md "Versioned kinesis input plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`application_name`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-application_name "application_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`checkpoint_interval_seconds`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-checkpoint_interval_seconds "checkpoint_interval_seconds") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`http_proxy`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-http_proxy "http_proxy") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`initial_position_in_stream`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-initial_position_in_stream "initial_position_in_stream") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`kinesis_stream_name`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-kinesis_stream_name "kinesis_stream_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`metrics`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-metrics "metrics") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `[nil, "cloudwatch"]` | No |
| [`non_proxy_hosts`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-non_proxy_hosts "non_proxy_hosts") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`profile`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-profile "profile") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`region`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-region "region") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`role_arn`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-role_arn "role_arn") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`role_session_name`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-role_session_name "role_session_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`additional_settings`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-additional_settings "additional_settings") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v2-3-0-plugins-inputs-kinesis.md#v2.3.0-plugins-inputs-kinesis-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
