...
This plugin supports the following configuration options plus the [Common options](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`break_on_match`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-break_on_match "break_on_match") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`keep_empty_captures`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-keep_empty_captures "keep_empty_captures") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`match`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-match "match") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`named_captures_only`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-named_captures_only "named_captures_only") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`overwrite`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-overwrite "overwrite") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`pattern_definitions`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-pattern_definitions "pattern_definitions") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`patterns_dir`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-patterns_dir "patterns_dir") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`patterns_files_glob`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-patterns_files_glob "patterns_files_glob") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tag_on_failure`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-tag_on_failure "tag_on_failure") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`tag_on_timeout`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-tag_on_timeout "tag_on_timeout") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`timeout_millis`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-timeout_millis "timeout_millis") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v4-0-2-plugins-filters-grok.md#v4.0.2-plugins-filters-grok-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
