...
Once configured to point to an Elasticsearch cluster, this filter will detect which ingest pipeline (if any) should be executed for each event, using an explicitly-defined [`pipeline_name`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-pipeline_name "pipeline_name") or auto-detecting the event’s data-stream and its default pipeline.
...
Read on for a guide to configuration, or jump to the [complete list of configuration options](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-options "Elastic Integration Filter Configuration Options").
...
* A Cloud Id (see [`cloud_id`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-cloud_id "cloud_id"))
* A list of one or more host URLs (see [`hosts`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-hosts "hosts"))
...
#### SSL Trust Configuration [_ssl_trust_configuration_22]
...
* A PEM-formatted list of trusted certificate authorities (see [`ssl_certificate_authorities`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_certificate_authorities "ssl_certificate_authorities"))
* A JKS- or PKCS12-formatted Keystore containing trusted certificates (see [`ssl_truststore_path`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_truststore_path "ssl_truststore_path"))

You can also configure which aspects of the proof-of-identity are verified (see [`ssl_verification_mode`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_verification_mode "ssl_verification_mode")).
...
* A PKCS8 Certificate/Key pair (see [`ssl_certificate`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_certificate "ssl_certificate"))
* A JKS- or PKCS12-formatted Keystore (see [`ssl_keystore_path`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_keystore_path "ssl_keystore_path"))
...
* ApiKey: (see [`api_key`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-api_key "api_key"))
* Cloud Auth: (see [`cloud_auth`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-cloud_auth "cloud_auth"))
* HTTP Basic Auth: (see [`username`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-username "username") and [`password`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-password "password"))
...
| **Redact** | `redact` | *none* |
| **GeoIp** | `geoip` | requires MaxMind GeoIP2 databases, which may be provided by Logstash’s Geoip Database Management *OR* configured using [`geoip_database_directory`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-geoip_database_directory "geoip_database_directory") |
...
This plugin uses Elasticsearch to resolve pipeline names into their pipeline definitions. When configured *without* an explicit [`pipeline_name`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-pipeline_name "pipeline_name"), or when a pipeline uses the Reroute Processor, it also uses Elasticsearch to establish mappings of data stream names to their respective default pipeline names.
...
This plugin supports the following configuration options plus the [Common options](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`api_key`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-api_key "api_key") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`cloud_auth`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-cloud_auth "cloud_auth") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`cloud_id`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-cloud_id "cloud_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`geoip_database_directory`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-geoip_database_directory "geoip_database_directory") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`hosts`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-hosts "hosts") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`password`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-password "password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`pipeline_name`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-pipeline_name "pipeline_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`ssl_certificate`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_certificate "ssl_certificate") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`ssl_certificate_authorities`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_certificate_authorities "ssl_certificate_authorities") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl_enabled`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_enabled "ssl_enabled") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`ssl_key`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_key "ssl_key") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`ssl_keystore_password`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_keystore_password "ssl_keystore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`ssl_keystore_path`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_keystore_path "ssl_keystore_path") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`ssl_key_passphrase`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_key_passphrase "ssl_key_passphrase") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`ssl_truststore_path`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_truststore_path "ssl_truststore_path") | [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path) | No |
| [`ssl_truststore_password`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_truststore_password "ssl_truststore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`ssl_verification_mode`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_verification_mode "ssl_verification_mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["full", "certificate", "none"]` | No |
| [`username`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-username "username") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
...
* There is no default value for this setting.
* Cannot be combined with \`[`ssl_enabled`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_enabled "ssl_enabled")⇒false\`.
...
* Constraints:
  ...
  * `https`-protocol hosts use HTTPS and cannot be combined with [`+ssl_enabled => false+`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_enabled "ssl_enabled").
  * `http`-protocol hosts use unsecured HTTP and cannot be combined with [`+ssl_enabled => true+`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_enabled "ssl_enabled").
...
* Set [`+ssl_enabled => false+`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_enabled "ssl_enabled")

#### `password` [v0.1.2-plugins-filters-elastic_integration-password]

* Value type is [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password)
* There is no default value for this setting.
* Required when request auth is configured with [`username`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-username "username")
...
* Value type is [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path)
* There is no default value for this setting.
* When present, [`ssl_key`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_key "ssl_key") and [`ssl_key_passphrase`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_key_passphrase "ssl_key_passphrase") are also required.
...
* There is no default value for this setting.
* Cannot be combined with configurations that disable SSL
* Cannot be combined with \`[`ssl_verification_mode`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_verification_mode "ssl_verification_mode")⇒none\`.
...
* it is implicitly disabled by providing `http`-protocol [`hosts`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-hosts "hosts").
...
* Value type is [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path)
* There is no default value for this setting.
* Required when connection identity is configured with [`ssl_certificate`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_certificate "ssl_certificate")
* Cannot be combined with configurations that disable SSL
...
* Value type is [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password)
* There is no default value for this setting.
* Required when connection identity is configured with [`ssl_keystore_path`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_keystore_path "ssl_keystore_path")
* Cannot be combined with configurations that disable SSL

Password for the [`ssl_keystore_path`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_keystore_path "ssl_keystore_path").

#### `ssl_keystore_path` [v0.1.2-plugins-filters-elastic_integration-ssl_keystore_path]

* Value type is [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path)
* There is no default value for this setting.
* When present, [`ssl_keystore_password`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_keystore_password "ssl_keystore_password") is also required.
* Cannot be combined with configurations that disable SSL
...
A password or passphrase of the [`ssl_key`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_key "ssl_key").

#### `ssl_truststore_path` [v0.1.2-plugins-filters-elastic_integration-ssl_truststore_path]

* Value type is [path](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#path)
* There is no default value for this setting.
* When present, [`ssl_truststore_password`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_truststore_password "ssl_truststore_password") is required.
* Cannot be combined with configurations that disable SSL
* Cannot be combined with \`[`ssl_verification_mode`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_verification_mode "ssl_verification_mode")⇒none\`.
...
* Value type is [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password)
* There is no default value for this setting.
* Required when connection trust is configured with [`ssl_truststore_path`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_truststore_path "ssl_truststore_path")
* Cannot be combined with configurations that disable SSL

Password for the [`ssl_truststore_path`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-ssl_truststore_path "ssl_truststore_path").
...
* Value type is [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string)
* There is no default value for this setting.
* When present, [`password`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-password "password") is also required.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v0-1-2-plugins-filters-elastic_integration.md#v0.1.2-plugins-filters-elastic_integration-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
