...
Duration settings can be specified in text form e.g. "250 ms", this string will be converted into decimal seconds. There are quite a few supported natural and abbreviated durations, see [string\_duration](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-string_duration) for the details.

| Setting | Input type | Required |
| :- | :- | :- |
| [`close_older`](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-close_older) | [number](/lsr/value-types.md#number) or [string\_duration](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-string_duration) | No |
...
| [`ignore_older`](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-ignore_older) | [number](/lsr/value-types.md#number) or [string\_duration](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-string_duration) | No |
...
| [`sincedb_clean_after`](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-sincedb_clean_after) | [number](/lsr/value-types.md#number) or [string\_duration](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-string_duration) | No |
| [`sincedb_path`](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-sincedb_path) | [string](/lsr/value-types.md#string) | No |
| [`sincedb_write_interval`](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-sincedb_write_interval) | [number](/lsr/value-types.md#number) or [string\_duration](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-string_duration) | No |
...
| [`stat_interval`](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-stat_interval) | [number](/lsr/value-types.md#number) or [string\_duration](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-string_duration) | No |
...
* Value type is [number](/lsr/value-types.md#number) or [string\_duration](v4-1-9-plugins-inputs-file.md#v4.1.9-plugins-inputs-file-string_duration)
