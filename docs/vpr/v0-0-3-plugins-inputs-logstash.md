...
You can also configure this plugin to require a specific username/password be provided by configuring [`username`](v0-0-3-plugins-inputs-logstash.md#v0.0.3-plugins-inputs-logstash-username) and [`password`](v0-0-3-plugins-inputs-logstash.md#v0.0.3-plugins-inputs-logstash-password). Doing so requires connecting [logstash output plugin](/lsr/plugins-outputs-logstash.md) clients to provide matching [`username`](v0-0-3-plugins-inputs-logstash.md#v0.0.3-plugins-inputs-logstash-username) and [`password`](v0-0-3-plugins-inputs-logstash.md#v0.0.3-plugins-inputs-logstash-password).
