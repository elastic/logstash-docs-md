...
| :- | :- |
| input {<br> logstash {<br> port => 8080<br> ssl\_keystore\_path<br> => "/path/to/logstash.p12"<br> ssl\_keystore\_password<br> => "${PASS}"<br> }<br>} | input {<br> logstash {<br> port => 8080<br> ssl\_enabled => false<br> }<br>} |
