...
| [`reconnect_interval`](v4-0-3-plugins-outputs-redis.md#v4.0.3-plugins-outputs-redis-reconnect_interval) | [number](logstash://reference/configuration-file-structure.md#number) | No |
