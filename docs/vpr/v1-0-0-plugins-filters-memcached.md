...
This plugin supports the following configuration options plus the [Common options](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`hosts`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-hosts "hosts") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`namespace`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-namespace "namespace") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`get`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-get "get") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`set`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-set "set") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`ttl`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-ttl "ttl") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-common-options "Common options") for a list of options supported by all filter plugins.
...
If specified, extracts the values from the given event fields, and sets the corresponding keys to those values in memcached with the configured [ttl](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-ttl "ttl")
...
For usages of this plugin that persist data to memcached (e.g., [`set`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-set "set")), the time-to-live in seconds
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v1-0-0-plugins-filters-memcached.md#v1.0.0-plugins-filters-memcached-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
