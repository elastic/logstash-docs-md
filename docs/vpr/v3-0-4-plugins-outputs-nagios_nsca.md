...
For other versions, see the [overview list](output-nagios_nsca-index.md "Versioned nagios_nsca output plugin docs").
...
This plugin supports the following configuration options plus the [Common options](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`host`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`message_format`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-message_format "message_format") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`nagios_host`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-nagios_host "nagios_host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`nagios_service`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-nagios_service "nagios_service") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`nagios_status`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-nagios_status "nagios_status") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`port`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`send_nsca_bin`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-send_nsca_bin "send_nsca_bin") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`send_nsca_config`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-send_nsca_config "send_nsca_config") | a valid filesystem path | No |

Also see [Common options](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-4-plugins-outputs-nagios_nsca.md#v3.0.4-plugins-outputs-nagios_nsca-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
