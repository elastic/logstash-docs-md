...
| :- | :- | :- |
| [`delimiter`](v5-0-2-plugins-codecs-cef.md#v5.0.2-plugins-codecs-cef-delimiter "delimiter") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`fields`](v5-0-2-plugins-codecs-cef.md#v5.0.2-plugins-codecs-cef-fields "fields") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`name`](v5-0-2-plugins-codecs-cef.md#v5.0.2-plugins-codecs-cef-name "name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`product`](v5-0-2-plugins-codecs-cef.md#v5.0.2-plugins-codecs-cef-product "product") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`severity`](v5-0-2-plugins-codecs-cef.md#v5.0.2-plugins-codecs-cef-severity "severity") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`signature`](v5-0-2-plugins-codecs-cef.md#v5.0.2-plugins-codecs-cef-signature "signature") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`vendor`](v5-0-2-plugins-codecs-cef.md#v5.0.2-plugins-codecs-cef-vendor "vendor") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`version`](v5-0-2-plugins-codecs-cef.md#v5.0.2-plugins-codecs-cef-version "version") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
