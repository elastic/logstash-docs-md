...
This plugin supports the following configuration options plus the [Common options](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`interval`](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-interval "interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`logfile`](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-logfile "logfile") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["Application", "Security", "System"]` | No |

Also see [Common options](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-common-options "Common options") for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v4-1-2-plugins-inputs-eventlog.md#v4.1.2-plugins-inputs-eventlog-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
