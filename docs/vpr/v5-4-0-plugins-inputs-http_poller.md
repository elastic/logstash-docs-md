...
This plugin supports the following configuration options plus the [Common options](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`automatic_retries`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-automatic_retries "automatic_retries") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`cacert`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-cacert "cacert") | a valid filesystem path | No |
| [`client_cert`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-client_cert "client_cert") | a valid filesystem path | No |
| [`client_key`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-client_key "client_key") | a valid filesystem path | No |
| [`connect_timeout`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-connect_timeout "connect_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`cookies`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-cookies "cookies") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`ecs_compatibility`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`follow_redirects`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-follow_redirects "follow_redirects") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`keepalive`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-keepalive "keepalive") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`keystore`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-keystore "keystore") | a valid filesystem path | No |
| [`keystore_password`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-keystore_password "keystore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`keystore_type`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-keystore_type "keystore_type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`metadata_target`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-metadata_target "metadata_target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`password`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-password "password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`pool_max`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-pool_max "pool_max") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`pool_max_per_route`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-pool_max_per_route "pool_max_per_route") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`proxy`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-proxy "proxy") | <<,>> | No |
| [`request_timeout`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-request_timeout "request_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`retry_non_idempotent`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-retry_non_idempotent "retry_non_idempotent") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`schedule`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-schedule "schedule") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | Yes |
| [`socket_timeout`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-socket_timeout "socket_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`ssl_supported_protocols`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-ssl_supported_protocols "ssl_supported_protocols") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`ssl_verification_mode`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-ssl_verification_mode "ssl_verification_mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`target`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`truststore`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-truststore "truststore") | a valid filesystem path | No |
| [`truststore_password`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-truststore_password "truststore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`truststore_type`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-truststore_type "truststore_type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`urls`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-urls "urls") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | Yes |
| [`user`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-user "user") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`validate_after_inactivity`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-validate_after_inactivity "validate_after_inactivity") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-common-options "Common options") for a list of options supported by all input plugins.
...
Password to be used in conjunction with [`user`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-user "user") for HTTP authentication.
...
Username to use with HTTP authentication for ALL requests. Note that you can also set this per-URL. If you set this you must also set the [`password`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-password "password") option.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v5-4-0-plugins-inputs-http_poller.md#v5.4.0-plugins-inputs-http_poller-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
