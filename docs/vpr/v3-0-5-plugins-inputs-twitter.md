...
| [`use_proxy`](v3-0-5-plugins-inputs-twitter.md#v3.0.5-plugins-inputs-twitter-use_proxy) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
