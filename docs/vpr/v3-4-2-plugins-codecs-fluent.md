...
For other versions, see the [overview list](codec-fluent-index.md "Versioned fluent codec plugin docs").
...
| :- | :- | :- |
| [`nanosecond_precision`](v3-4-2-plugins-codecs-fluent.md#v3.4.2-plugins-codecs-fluent-nanosecond_precision "nanosecond_precision") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`target`](v3-4-2-plugins-codecs-fluent.md#v3.4.2-plugins-codecs-fluent-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
