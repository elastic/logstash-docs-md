...
| [`passive`](v4-0-8-plugins-outputs-rabbitmq.md#v4.0.8-plugins-outputs-rabbitmq-passive) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
