...
| [`max_messages`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-max_messages) | [number](logstash://reference/configuration-file-structure.md#number) | Yes |
| [`project_id`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-project_id) | [string](logstash://reference/configuration-file-structure.md#string) | Yes |
| [`subscription`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-subscription) | [string](logstash://reference/configuration-file-structure.md#string) | Yes |
| [`topic`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-topic) | [string](logstash://reference/configuration-file-structure.md#string) | Yes |
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`codec`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-codec) | [codec](logstash://reference/configuration-file-structure.md#codec) | No |
| [`enable_metric`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`tags`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-tags) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`type`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-type) | [string](logstash://reference/configuration-file-structure.md#string) | No |
