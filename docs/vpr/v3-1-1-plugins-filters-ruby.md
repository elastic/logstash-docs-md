...
This plugin supports the following configuration options plus the [Common options](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`code`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-code "code") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`init`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-init "init") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`path`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-path "path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`script_params`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-script_params "script_params") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash),{} | No |
| [`tag_on_exception`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-tag_on_exception "tag_on_exception") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string),\_rubyexception | No |

Also see [Common options](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
