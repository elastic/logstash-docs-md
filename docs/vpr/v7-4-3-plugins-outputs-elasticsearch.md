...
| [`pipeline`](v7-4-3-plugins-outputs-elasticsearch.md#v7.4.3-plugins-outputs-elasticsearch-pipeline) | [string](logstash://reference/configuration-file-structure.md#string) | No |
