...
This plugin supports the following configuration options plus the [Common options](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`end_tag`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-end_tag "end_tag") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`new_event_on_match`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-new_event_on_match "new_event_on_match") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`start_tag`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-start_tag "start_tag") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`timeout`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-timeout "timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`unique_id_field`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-unique_id_field "unique_id_field") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |

Also see [Common options](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v4-0-2-plugins-filters-elapsed.md#v4.0.2-plugins-filters-elapsed-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
