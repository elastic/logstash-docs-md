...
For other versions, see the [overview list](codec-edn-index.md "Versioned edn codec plugin docs").
...
| :- | :- | :- |
| [`target`](v3-1-0-plugins-codecs-edn.md#v3.1.0-plugins-codecs-edn-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
