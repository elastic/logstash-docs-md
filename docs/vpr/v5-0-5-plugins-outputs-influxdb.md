...
This plugin supports the following configuration options plus the [Common options](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`allow_time_override`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-allow_time_override "allow_time_override") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`coerce_values`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-coerce_values "coerce_values") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`data_points`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-data_points "data_points") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | Yes |
| [`db`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-db "db") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`exclude_fields`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-exclude_fields "exclude_fields") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`flush_size`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-flush_size "flush_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`host`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`idle_flush_time`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-idle_flush_time "idle_flush_time") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`initial_delay`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-initial_delay "initial_delay") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`max_retries`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-max_retries "max_retries") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`measurement`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-measurement "measurement") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`password`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-password "password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`port`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`retention_policy`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-retention_policy "retention_policy") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`send_as_tags`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-send_as_tags "send_as_tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`ssl`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-ssl "ssl") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`time_precision`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-time_precision "time_precision") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["n", "u", "ms", "s", "m", "h"]` | No |
| [`use_event_fields_for_data_points`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-use_event_fields_for_data_points "use_event_fields_for_data_points") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`user`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-user "user") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
