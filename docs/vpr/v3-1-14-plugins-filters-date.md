...
This plugin supports the following configuration options plus the [Common options](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`locale`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-locale "locale") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`match`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-match "match") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`tag_on_failure`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-tag_on_failure "tag_on_failure") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`target`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`timezone`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-timezone "timezone") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-1-14-plugins-filters-date.md#v3.1.14-plugins-filters-date-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
