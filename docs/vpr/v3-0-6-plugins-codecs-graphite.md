...
| :- | :- | :- |
| [`exclude_metrics`](v3-0-6-plugins-codecs-graphite.md#v3.0.6-plugins-codecs-graphite-exclude_metrics "exclude_metrics") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`fields_are_metrics`](v3-0-6-plugins-codecs-graphite.md#v3.0.6-plugins-codecs-graphite-fields_are_metrics "fields_are_metrics") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_metrics`](v3-0-6-plugins-codecs-graphite.md#v3.0.6-plugins-codecs-graphite-include_metrics "include_metrics") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`metrics`](v3-0-6-plugins-codecs-graphite.md#v3.0.6-plugins-codecs-graphite-metrics "metrics") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`metrics_format`](v3-0-6-plugins-codecs-graphite.md#v3.0.6-plugins-codecs-graphite-metrics_format "metrics_format") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
