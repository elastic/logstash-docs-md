...
| --- | --- | --- |
| [`followed_by_tags`](v2-0-5-plugins-filters-metaevent.md#v2.0.5-plugins-filters-metaevent-followed_by_tags) | [array](logstash://reference/configuration-file-structure.md#array) | Yes |
| [`period`](v2-0-5-plugins-filters-metaevent.md#v2.0.5-plugins-filters-metaevent-period) | [number](logstash://reference/configuration-file-structure.md#number) | No |
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](v2-0-5-plugins-filters-metaevent.md#v2.0.5-plugins-filters-metaevent-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`add_tag`](v2-0-5-plugins-filters-metaevent.md#v2.0.5-plugins-filters-metaevent-add_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`enable_metric`](v2-0-5-plugins-filters-metaevent.md#v2.0.5-plugins-filters-metaevent-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](v2-0-5-plugins-filters-metaevent.md#v2.0.5-plugins-filters-metaevent-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`periodic_flush`](v2-0-5-plugins-filters-metaevent.md#v2.0.5-plugins-filters-metaevent-periodic_flush) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`remove_field`](v2-0-5-plugins-filters-metaevent.md#v2.0.5-plugins-filters-metaevent-remove_field) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`remove_tag`](v2-0-5-plugins-filters-metaevent.md#v2.0.5-plugins-filters-metaevent-remove_tag) | [array](logstash://reference/configuration-file-structure.md#array) | No |
