...
### Batch Publishing [_batch_publishing_22]
...
This plugin supports the following configuration options plus the [Common options](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`access_key_id`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-access_key_id "access_key_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`aws_credentials_file`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-aws_credentials_file "aws_credentials_file") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`batch_events`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-batch_events "batch_events") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`message_max_size`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-message_max_size "message_max_size") | [bytes](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#bytes) | No |
| [`proxy_uri`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-proxy_uri "proxy_uri") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`queue`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-queue "queue") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`region`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-region "region") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["us-east-1", "us-east-2", "us-west-1", "us-west-2", "eu-central-1", "eu-west-1", "eu-west-2", "ap-southeast-1", "ap-southeast-2", "ap-northeast-1", "ap-northeast-2", "sa-east-1", "us-gov-west-1", "cn-north-1", "ap-south-1", "ca-central-1"]` | No |
| [`secret_access_key`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-secret_access_key "secret_access_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`session_token`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-session_token "session_token") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-2-plugins-outputs-sqs.md#v4.0.2-plugins-outputs-sqs-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
