...
For other versions, see the [overview list](codec-avro-index.md "Versioned avro codec plugin docs").
...
| :- | :- | :- |
| [`ecs_compatibility`](v3-4-1-plugins-codecs-avro.md#v3.4.1-plugins-codecs-avro-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`encoding`](v3-4-1-plugins-codecs-avro.md#v3.4.1-plugins-codecs-avro-encoding "encoding") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["binary", "base64"]` | No |
| [`schema_uri`](v3-4-1-plugins-codecs-avro.md#v3.4.1-plugins-codecs-avro-schema_uri "schema_uri") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`tag_on_failure`](v3-4-1-plugins-codecs-avro.md#v3.4.1-plugins-codecs-avro-tag_on_failure "tag_on_failure") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`target`](v3-4-1-plugins-codecs-avro.md#v3.4.1-plugins-codecs-avro-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
