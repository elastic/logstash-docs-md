...
* [Create a Logstash consumer group](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-bp-group "Create a Logstash consumer group")
* [Avoid overwriting offset with multiple Event Hubs](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-bp-multihub "Avoid overwriting offset with multiple Event Hubs")
* [Set number of threads correctly](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-bp-threads "Set number of threads correctly")
...
This plugin supports the following configuration options plus the [Common options](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`config_mode`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-config_mode "config_mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), (`basic` or `advanced`) | No |
| [`event_hubs`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-event_hubs "event_hubs") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes, when `config_mode => advanced` |
| [`event_hub_connections`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-event_hub_connections "event_hub_connections") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes, when `config_mode => basic` |
| [`event_hub_connection`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-event_hub_connection "event_hub_connection") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes, when `config_mode => advanced` |
| [`checkpoint_interval`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-checkpoint_interval "checkpoint_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`consumer_group`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-consumer_group "consumer_group") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`decorate_events`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-decorate_events "decorate_events") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`initial_position`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-initial_position "initial_position") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), (`beginning`, `end`, or `look_back`) | No |
| [`initial_position_look_back`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-initial_position_look_back "initial_position_look_back") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No, unless `initial_position => look_back` |
| [`max_batch_size`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-max_batch_size "max_batch_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`storage_connection`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-storage_connection "storage_connection") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`storage_container`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-storage_container "storage_container") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`threads`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-threads "threads") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-common-options "Common options") for a list of options supported by all input plugins.
...
Sets configuration to either [Basic configuration (default)](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-eh_basic_config "Basic configuration (default)") or [Advanced configuration](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-eh_advanced_config "Advanced configuration").
...
The number of threads should be the number of Event Hubs plus one or more. See [Best practices](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-best-practices "Best practices") for more information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v1-5-1-plugins-inputs-azure_event_hubs.md#v1.5.1-plugins-inputs-azure_event_hubs-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
