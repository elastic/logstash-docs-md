...
This plugin supports the following configuration options plus the [Common options](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`skip_on_invalid_json`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-skip_on_invalid_json "skip_on_invalid_json") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`source`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-source "source") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`tag_on_failure`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-tag_on_failure "tag_on_failure") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`target`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-0-3-plugins-filters-json.md#v3.0.3-plugins-filters-json-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
