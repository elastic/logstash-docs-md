...
This plugin supports the following configuration options plus the [Common options](v3-1-3-plugins-outputs-exec.md#v3.1.3-plugins-outputs-exec-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`command`](v3-1-3-plugins-outputs-exec.md#v3.1.3-plugins-outputs-exec-command "command") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`quiet`](v3-1-3-plugins-outputs-exec.md#v3.1.3-plugins-outputs-exec-quiet "quiet") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |

Also see [Common options](v3-1-3-plugins-outputs-exec.md#v3.1.3-plugins-outputs-exec-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-1-3-plugins-outputs-exec.md#v3.1.3-plugins-outputs-exec-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-1-3-plugins-outputs-exec.md#v3.1.3-plugins-outputs-exec-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-3-plugins-outputs-exec.md#v3.1.3-plugins-outputs-exec-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
