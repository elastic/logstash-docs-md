...
JMS data is application specific. ECS compliance for fields depends on the use case. The plugin includes sensible defaults that change based on [ECS compatibility mode](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-ecs_compatibility "ecs_compatibility"). When ECS compatibility is disabled, headers, properties, and payload are targeted at the root level of the event to maintain compatibility with legacy usage of this plugin. When targeting an ECS version, headers and properties target `@metadata` sub-fields unless configured otherwise in order to avoid conflict with ECS fields. See [`headers_target`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-headers_target "headers_target"), [`properties_target`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-properties_target "properties_target") and [`target`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-target "target").
...
This plugin supports the following configuration options plus the [Common options](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`broker_url`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-broker_url "broker_url") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`destination`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-destination "destination") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`durable_subscriber`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-durable_subscriber "durable_subscriber") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`durable_subscriber_client_id`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-durable_subscriber_client_id "durable_subscriber_client_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`durable_subscriber_name`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-durable_subscriber_name "durable_subscriber_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`ecs_compatibility`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-ecs_compatibility "ecs_compatibility") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`factory`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-factory "factory") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`factory_settings`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-factory_settings "factory_settings") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`headers_target`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-headers_target "headers_target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`include_body`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-include_body "include_body") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_header`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-include_header "include_header") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_headers`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-include_headers "include_headers") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`include_properties`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-include_properties "include_properties") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`interval`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-interval "interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`jndi_context`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-jndi_context "jndi_context") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`jndi_name`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-jndi_name "jndi_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`keystore`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-keystore "keystore") | a valid filesystem path | No |
| [`keystore_password`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-keystore_password "keystore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`oracle_aq_buffered_messages`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-oracle_aq_buffered_messages "oracle_aq_buffered_messages") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`password`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-password "password") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`properties_target`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-properties_target "properties_target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`pub_sub`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-pub_sub "pub_sub") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`require_jars`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-require_jars "require_jars") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`runner`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-runner "runner") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | *Deprecated* |
| [`selector`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-selector "selector") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`skip_headers`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-skip_headers "skip_headers") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`skip_properties`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-skip_properties "skip_properties") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`system_properties`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-system_properties "system_properties") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`target`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`threads`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-threads "threads") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`timeout`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-timeout "timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`truststore`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-truststore "truststore") | a valid filesystem path | No |
| [`truststore_password`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-truststore_password "truststore_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`use_jms_timestamp`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-use_jms_timestamp "use_jms_timestamp") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`username`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-username "username") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`yaml_file`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-yaml_file "yaml_file") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`yaml_section`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-yaml_section "yaml_section") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-common-options "Common options") for a list of options supported by all input plugins.
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the *default* value of [`headers_target`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-headers_target "headers_target") and [`properties_target`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-properties_target "properties_target").
...
* Default value depends on whether [`ecs_compatibility`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-ecs_compatibility "ecs_compatibility") is enabled:

  * ECS Compatibility disabled: no default value for this setting
  * ECS Compatibility enabled: \`"\[@metadata]\[input]\[jms]\[headers]"

The name of the field under which JMS headers will be added, if [`include_headers`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-include_headers "include_headers") is set.
...
The name of the field under which JMS properties will be added, if [`include_properties`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-include_properties "include_properties") is set.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v3-2-2-plugins-inputs-jms.md#v3.2.2-plugins-inputs-jms-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
