...
This plugin supports the following configuration options plus the [Common options](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`every`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-every "every") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`replay`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-replay "replay") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`time`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-time "time") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-0-6-plugins-filters-sleep.md#v3.0.6-plugins-filters-sleep-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
