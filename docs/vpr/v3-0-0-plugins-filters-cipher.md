...
This plugin supports the following configuration options plus the [Common options](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`algorithm`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-algorithm "algorithm") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`base64`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-base64 "base64") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`cipher_padding`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-cipher_padding "cipher_padding") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`iv_random_length`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-iv_random_length "iv_random_length") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`key`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-key "key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`key_pad`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-key_pad "key_pad") | <<,>> | No |
| [`key_size`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-key_size "key_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`max_cipher_reuse`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-max_cipher_reuse "max_cipher_reuse") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`mode`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-mode "mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`source`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-source "source") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`target`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-0-0-plugins-filters-cipher.md#v3.0.0-plugins-filters-cipher-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
