...
| [`message_properties`](v7-0-2-plugins-outputs-rabbitmq.md#v7.0.2-plugins-outputs-rabbitmq-message_properties) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
