...
See the [`jdbc_driver_library`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_driver_library "jdbc_driver_library") and [`jdbc_driver_class`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_driver_class "jdbc_driver_class") options for more info.
...
### Configuring SQL statement [_configuring_sql_statement_28]
...
This plugin supports the following configuration options plus the [Common options](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`clean_run`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-clean_run "clean_run") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`columns_charset`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-columns_charset "columns_charset") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`connection_retry_attempts`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-connection_retry_attempts "connection_retry_attempts") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`connection_retry_attempts_wait_time`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-connection_retry_attempts_wait_time "connection_retry_attempts_wait_time") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`jdbc_connection_string`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_connection_string "jdbc_connection_string") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`jdbc_default_timezone`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_default_timezone "jdbc_default_timezone") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`jdbc_driver_class`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_driver_class "jdbc_driver_class") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`jdbc_driver_library`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_driver_library "jdbc_driver_library") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`jdbc_fetch_size`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_fetch_size "jdbc_fetch_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`jdbc_page_size`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_page_size "jdbc_page_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`jdbc_paging_enabled`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_paging_enabled "jdbc_paging_enabled") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`jdbc_password`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_password "jdbc_password") | [password](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#password) | No |
| [`jdbc_password_filepath`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_password_filepath "jdbc_password_filepath") | a valid filesystem path | No |
| [`jdbc_pool_timeout`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_pool_timeout "jdbc_pool_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`jdbc_user`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_user "jdbc_user") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`jdbc_validate_connection`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_validate_connection "jdbc_validate_connection") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`jdbc_validation_timeout`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-jdbc_validation_timeout "jdbc_validation_timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`last_run_metadata_path`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-last_run_metadata_path "last_run_metadata_path") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`lowercase_column_names`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-lowercase_column_names "lowercase_column_names") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`parameters`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-parameters "parameters") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`plugin_timezone`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-plugin_timezone "plugin_timezone") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["local", "utc"]` | No |
| [`prepared_statement_bind_values`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-prepared_statement_bind_values "prepared_statement_bind_values") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`prepared_statement_name`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-prepared_statement_name "prepared_statement_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`record_last_run`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-record_last_run "record_last_run") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`schedule`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-schedule "schedule") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`sequel_opts`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-sequel_opts "sequel_opts") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`sql_log_level`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-sql_log_level "sql_log_level") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["fatal", "error", "warn", "info", "debug"]` | No |
| [`statement`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-statement "statement") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`statement_filepath`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-statement_filepath "statement_filepath") | a valid filesystem path | No |
| [`target`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-target "target") | [field reference](https://www.elastic.co/guide/en/logstash/current/field-references-deepdive.html) | No |
| [`tracking_column`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-tracking_column "tracking_column") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tracking_column_type`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-tracking_column_type "tracking_column_type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["numeric", "timestamp"]` | No |
| [`use_column_value`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-use_column_value "use_column_value") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`use_prepared_statements`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-use_prepared_statements "use_prepared_statements") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |

Also see [Common options](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-common-options "Common options") for a list of options supported by all input plugins.
...
Whether to save state or not in [`last_run_metadata_path`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-last_run_metadata_path "last_run_metadata_path")
...
When set to `true`, uses the defined [`tracking_column`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-tracking_column "tracking_column") value as the `:sql_last_value`. When set to `false`, `:sql_last_value` reflects the last time the query was executed.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`codec`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`tags`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-tags "tags") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`type`](v5-1-6-plugins-inputs-jdbc.md#v5.1.6-plugins-inputs-jdbc-type "type") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
