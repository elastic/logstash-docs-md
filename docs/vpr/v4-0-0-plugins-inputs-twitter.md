...
| [`use_proxy`](v4-0-0-plugins-inputs-twitter.md#v4.0.0-plugins-inputs-twitter-use_proxy) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
