...
* **lookups**
  ...
  2. Defines the columns, types, and indexes used to build the local database structure. The column names and types should match the external database. The order of table definitions is significant and should match that of the loader queries. See [Loader column and local\_db\_object order dependency](v5-4-11-plugins-filters-jdbc_static.md#v5.4.11-plugins-filters-jdbc_static-object_order).
