...
This plugin supports the following configuration options plus the [Common options](v3-1-4-plugins-outputs-opentsdb.md#v3.1.4-plugins-outputs-opentsdb-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`host`](v3-1-4-plugins-outputs-opentsdb.md#v3.1.4-plugins-outputs-opentsdb-host "host") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`metrics`](v3-1-4-plugins-outputs-opentsdb.md#v3.1.4-plugins-outputs-opentsdb-metrics "metrics") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | Yes |
| [`port`](v3-1-4-plugins-outputs-opentsdb.md#v3.1.4-plugins-outputs-opentsdb-port "port") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v3-1-4-plugins-outputs-opentsdb.md#v3.1.4-plugins-outputs-opentsdb-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-1-4-plugins-outputs-opentsdb.md#v3.1.4-plugins-outputs-opentsdb-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-1-4-plugins-outputs-opentsdb.md#v3.1.4-plugins-outputs-opentsdb-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-1-4-plugins-outputs-opentsdb.md#v3.1.4-plugins-outputs-opentsdb-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
