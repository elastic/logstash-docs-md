...
| [`project_name`](v1-0-4-plugins-outputs-monasca_log_api.md#v1.0.4-plugins-outputs-monasca_log_api-project_name) | [string](logstash://reference/configuration-file-structure.md#string) | Yes |
