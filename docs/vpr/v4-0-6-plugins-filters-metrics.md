...
This plugin supports the following configuration options plus the [Common options](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`clear_interval`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-clear_interval "clear_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`flush_interval`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-flush_interval "flush_interval") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`ignore_older_than`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-ignore_older_than "ignore_older_than") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`meter`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-meter "meter") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`percentiles`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-percentiles "percentiles") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`rates`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-rates "rates") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`timer`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-timer "timer") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |

Also see [Common options](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v4-0-6-plugins-filters-metrics.md#v4.0.6-plugins-filters-metrics-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
