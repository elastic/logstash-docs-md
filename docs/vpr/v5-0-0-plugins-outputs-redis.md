...
| [`reconnect_interval`](v5-0-0-plugins-outputs-redis.md#v5.0.0-plugins-outputs-redis-reconnect_interval) | [number](logstash://reference/configuration-file-structure.md#number) | No |
