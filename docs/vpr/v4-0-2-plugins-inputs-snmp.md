...
| [`oid_map_field_values`](v4-0-2-plugins-inputs-snmp.md#v4.0.2-plugins-inputs-snmp-oid_map_field_values) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
