...
For other versions, see the [overview list](codec-protobuf-index.md "Versioned protobuf codec plugin docs").

To learn more about Logstash, see the [Logstash Reference](https://www.elastic.co/guide/en/logstash/current/index.html).

### Getting help [_getting_help_2435]
...
| :- | :- | :- |
| [`class_name`](v1-3-0-plugins-codecs-protobuf.md#v1.3.0-plugins-codecs-protobuf-class_name "class_name") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`class_file`](v1-3-0-plugins-codecs-protobuf.md#v1.3.0-plugins-codecs-protobuf-class_file "class_file") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`protobuf_root_directory`](v1-3-0-plugins-codecs-protobuf.md#v1.3.0-plugins-codecs-protobuf-protobuf_root_directory "protobuf_root_directory") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`include_path`](v1-3-0-plugins-codecs-protobuf.md#v1.3.0-plugins-codecs-protobuf-include_path "include_path") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`protobuf_version`](v1-3-0-plugins-codecs-protobuf.md#v1.3.0-plugins-codecs-protobuf-protobuf_version "protobuf_version") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | Yes |
| [`stop_on_error`](v1-3-0-plugins-codecs-protobuf.md#v1.3.0-plugins-codecs-protobuf-stop_on_error "stop_on_error") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`pb3_encoder_autoconvert_types`](v1-3-0-plugins-codecs-protobuf.md#v1.3.0-plugins-codecs-protobuf-pb3_encoder_autoconvert_types "pb3_encoder_autoconvert_types") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
