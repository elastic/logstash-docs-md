...
This plugin supports the following configuration options plus the [Common options](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_tag_on_timeout`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-add_tag_on_timeout "add_tag_on_timeout") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`address`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-address "address") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`field`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-field "field") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`mode`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-mode "mode") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string), one of `["server", "client"]` | No |
| [`retries`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-retries "retries") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`sentinel`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-sentinel "sentinel") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`sockopt`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-sockopt "sockopt") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`timeout`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-timeout "timeout") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |

Also see [Common options](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v3-0-2-plugins-filters-zeromq.md#v3.0.2-plugins-filters-zeromq-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
