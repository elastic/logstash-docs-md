...
This plugin supports the following configuration options plus the [Common options](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`access_key_id`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-access_key_id "access_key_id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`aws_credentials_file`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-aws_credentials_file "aws_credentials_file") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`batch_size`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-batch_size "batch_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
| [`dimensions`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-dimensions "dimensions") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`field_dimensions`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-field_dimensions "field_dimensions") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`field_metricname`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-field_metricname "field_metricname") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`field_namespace`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-field_namespace "field_namespace") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`field_unit`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-field_unit "field_unit") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`field_value`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-field_value "field_value") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`metricname`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-metricname "metricname") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`namespace`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-namespace "namespace") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`proxy_uri`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-proxy_uri "proxy_uri") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`queue_size`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-queue_size "queue_size") | [number](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#number) | No |
...
| [`secret_access_key`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-secret_access_key "secret_access_key") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`session_token`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-session_token "session_token") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`timeframe`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-timeframe "timeframe") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
...
| [`value`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-value "value") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |

Also see [Common options](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-common-options "Common options") for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-codec "codec") | [codec](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#codec) | No |
| [`enable_metric`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v3-0-5-plugins-outputs-cloudwatch.md#v3.0.5-plugins-outputs-cloudwatch-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
