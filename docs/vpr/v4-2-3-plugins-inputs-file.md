...
| [`file_sort_direction`](v4-2-3-plugins-inputs-file.md#v4.2.3-plugins-inputs-file-file_sort_direction) | [string](logstash://reference/configuration-file-structure.md#string), one of `["asc", "desc"]` | No |
