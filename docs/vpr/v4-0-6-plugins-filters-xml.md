...
This plugin supports the following configuration options plus the [Common options](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-common-options "Common options") described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`force_array`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-force_array "force_array") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`force_content`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-force_content "force_content") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`namespaces`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-namespaces "namespaces") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`remove_namespaces`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-remove_namespaces "remove_namespaces") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`source`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-source "source") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | Yes |
| [`store_xml`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-store_xml "store_xml") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`suppress_empty`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-suppress_empty "suppress_empty") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`target`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-target "target") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`xpath`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-xpath "xpath") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |

Also see [Common options](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-common-options "Common options") for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-add_field "add_field") | [hash](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#hash) | No |
| [`add_tag`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-add_tag "add_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`enable_metric`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-enable_metric "enable_metric") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`id`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-id "id") | [string](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#string) | No |
| [`periodic_flush`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-periodic_flush "periodic_flush") | [boolean](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#boolean) | No |
| [`remove_field`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-remove_field "remove_field") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
| [`remove_tag`](v4-0-6-plugins-filters-xml.md#v4.0.6-plugins-filters-xml-remove_tag "remove_tag") | [array](https://www.elastic.co/guide/en/logstash/current/configuration-file-structure.html#array) | No |
